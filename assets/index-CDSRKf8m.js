 ...
 */var ag;function GS(){if(ag)return ht;ag=1;var a=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),s=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),u=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),g=Symbol.iterator;function _(F){return F===null||typeof F!="object"?null:(F=g&&F[g]||F["@@iterator"],typeof F=="function"?F:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function x(F,K,Le){this.props=F,this.context=K,this.refs=M,this.updater=Le||S}x.prototype.isReactComponent={},x.prototype.setState=function(F,K){if(typeof F!="object"&&typeof F!="function"&&F!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,F,K,"setState")},x.prototype.forceUpdate=function(F){this.updater.enqueueForceUpdate(this,F,"forceUpdate")};function y(){}y.prototype=x.prototype;function b(F,K,Le){this.props=F,this.context=K,this.refs=M,this.updater=Le||S}var I=b.prototype=new y;I.constructor=b,E(I,x.prototype),I.isPureReactComponent=!0;var R=Array.isArray,P=Object.prototype.hasOwnProperty,L={current:null},N={key:!0,ref:!0,__self:!0,__source:!0};function T(F,K,Le){var Fe,Ue={},ae=null,ve=null;if(K!=null)for(Fe in K.ref!==void 0&&(ve=K.ref),K.key!==void 0&&(ae=""+K.key),K)P.call(K,Fe)&&!N.hasOwnProperty(Fe)&&(Ue[Fe]=K[Fe]);var me=arguments.length-2;if(me===1)Ue.children=Le;else if(1<me){for(var Oe=Array(me),Qe=0;Qe<me;Qe++)Oe[Qe]=arguments[Qe+2];Ue.children=Oe}if(F&&F.defaultProps)for(Fe in me=F.defaultProps,me)Ue[Fe]===void 0&&(Ue[Fe]=me[Fe]);return{$$typeof:a,type:F,key:ae,ref:ve,props:Ue,_owner:L.current}}function D(F,K){return{$$typeof:a,type:F.type,key:K,ref:F.ref,props:F.props,_owner:F._owner}}function k(F){return typeof F=="object"&&F!==null&&F.$$typeof===a}function B(F){var K={"=":"=0",":":"=2"};return"$"+F.replace(/[=:]/g,function(Le){return K[Le]})}var Y=/\/+/g;function j(F,K){return typeof F=="object"&&F!==null&&F.key!=null?B(""+F.key):K.toString(36)}function re(F,K,Le,Fe,Ue){var ae=typeof F;(ae==="undefined"||ae==="boolean")&&(F=null);var ve=!1;if(F===null)ve=!0;else switch(ae){case"string":case"number":ve=!0;break;case"object":switch(F.$$typeof){case a:case e:ve=!0}}if(ve)return ve=F,Ue=Ue(ve),F=Fe===""?"."+j(ve,0):Fe,R(Ue)?(Le="",F!=null&&(Le=F.replace(Y,"$&/")+"/"),re(Ue,K,Le,"",function(Qe){return Qe})):Ue!=null&&(k(Ue)&&(Ue=D(Ue,Le+(!Ue.key||ve&&ve.key===Ue.key?"":(""+Ue.key).replace(Y,"$&/")+"/")+F)),K.push(Ue)),1;if(ve=0,Fe=Fe===""?".":Fe+":",R(F))for(var me=0;me<F.length;me++){ae=F[me];var Oe=Fe+j(ae,me);ve+=re(ae,K,Le,Oe,Ue)}else if(Oe=_(F),typeof Oe=="function")for(F=Oe.call(F),me=0;!(ae=F.next()).done;)ae=ae.value,Oe=Fe+j(ae,me++),ve+=re(ae,K,Le,Oe,Ue);else if(ae==="object")throw K=String(F),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(F).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.");return ve}function W(F,K,Le){if(F==null)return F;var Fe=[],Ue=0;return re(F,Fe,"","",function(ae){return K.call(Le,ae,Ue++)}),Fe}function Q(F){if(F._status===-1){var K=F._result;K=K(),K.then(function(Le){(F._status===0||F._status===-1)&&(F._status=1,F._result=Le)},function(Le){(F._status===0||F._status===-1)&&(F._status=2,F._result=Le)}),F._status===-1&&(F._status=0,F._result=K)}if(F._status===1)return F._result.default;throw F._result}var V={current:null},H={transition:null},oe={ReactCurrentDispatcher:V,ReactCurrentBatchConfig:H,ReactCurrentOwner:L};function se(){throw Error("act(...) is not supported in production builds of React.")}return ht.Children={map:W,forEach:function(F,K,Le){W(F,function(){K.apply(this,arguments)},Le)},count:function(F){var K=0;return W(F,function(){K++}),K},toArray:function(F){return W(F,function(K){return K})||[]},only:function(F){if(!k(F))throw Error("React.Children.only expected to receive a single React element child.");return F}},ht.Component=x,ht.Fragment=t,ht.Profiler=s,ht.PureComponent=b,ht.StrictMode=i,ht.Suspense=d,ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=oe,ht.act=se,ht.cloneElement=function(F,K,Le){if(F==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+F+".");var Fe=E({},F.props),Ue=F.key,ae=F.ref,ve=F._owner;if(K!=null){if(K.ref!==void 0&&(ae=K.ref,ve=L.current),K.key!==void 0&&(Ue=""+K.key),F.type&&F.type.defaultProps)var me=F.type.defaultProps;for(Oe in K)P.call(K,Oe)&&!N.hasOwnProperty(Oe)&&(Fe[Oe]=K[Oe]===void 0&&me!==void 0?me[Oe]:K[Oe])}var Oe=arguments.length-2;if(Oe===1)Fe.children=Le;else if(1<Oe){me=Array(Oe);for(var Qe=0;Qe<Oe;Qe++)me[Qe]=arguments[Qe+2];Fe.children=me}return{$$typeof:a,type:F.type,key:Ue,ref:ae,props:Fe,_owner:ve}},ht.createContext=function(F){return F={$$typeof:u,_currentValue:F,_currentValue2:F,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},F.Provider={$$typeof:o,_context:F},F.Consumer=F},ht.createElement=T,ht.createFactory=function(F){var K=T.bind(null,F);return K.type=F,K},ht.createRef=function(){return{current:null}},ht.forwardRef=function(F){return{$$typeof:c,render:F}},ht.isValidElement=k,ht.lazy=function(F){return{$$typeof:p,_payload:{_status:-1,_result:F},_init:Q}},ht.memo=function(F,K){return{$$typeof:h,type:F,compare:K===void 0?null:K}},ht.startTransition=function(F){var K=H.transition;H.transition={};try{F()}finally{H.transition=K}},ht.unstable_act=se,ht.useCallback=function(F,K){return V.current.useCallback(F,K)},ht.useContext=function(F){return V.current.useContext(F)},ht.useDebugValue=function(){},ht.useDeferredValue=function(F){return V.current.useDeferredValue(F)},ht.useEffect=function(F,K){return V.current.useEffect(F,K)},ht.useId=function(){return V.current.useId()},ht.useImperativeHandle=function(F,K,Le){return V.current.useImperativeHandle(F,K,Le)},ht.useInsertionEffect=function(F,K){return V.current.useInsertionEffect(F,K)},ht.useLayoutEffect=function(F,K){return V.current.useLayoutEffect(F,K)},ht.useMemo=function(F,K){return V.current.useMemo(F,K)},ht.useReducer=function(F,K,Le){return V.current.useReducer(F,K,Le)},ht.useRef=function(F){return V.current.useRef(F)},ht.useState=function(F){return V.current.useState(F)},ht.useSyncExternalStore=function(F,K,Le){return V.current.useSyncExternalStore(F,K,Le)},ht.useTransition=function(){return V.current.useTransition()},ht.version="18.3.1",ht}var og;function op(){return og||(og=1,fd.exports=GS()),fd.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lg;function WS(){if(lg)return Ko;lg=1;var a=op(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,s=a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,o={key:!0,ref:!0,__self:!0,__source:!0};function u(c,d,h){var p,g={},_=null,S=null;h!==void 0&&(_=""+h),d.key!==void 0&&(_=""+d.key),d.ref!==void 0&&(S=d.ref);for(p in d)i.call(d,p)&&!o.hasOwnProperty(p)&&(g[p]=d[p]);if(c&&c.defaultProps)for(p in d=c.defaultProps,d)g[p]===void 0&&(g[p]=d[p]);return{$$typeof:e,type:c,key:_,ref:S,props:g,_owner:s.current}}return Ko.Fragment=t,Ko.jsx=u,Ko.jsxs=u,Ko}var ug;function XS(){return ug||(ug=1,cd.exports=WS()),cd.exports}var he=XS(),pt=op();const YS=HS(pt);var Pu={},dd={exports:{}},jn={},hd={exports:{}},pd={};/**
 * @license React
...
}`,Zw=[new le(1,0,0),new le(-1,0,0),new le(0,1,0),new le(0,-1,0),new le(0,0,1),new le(0,0,-1)],jw=[new le(0,-1,0),new le(0,-1,0),new le(0,0,1),new le(0,0,-1),new le(0,-1,0),new le(0,-1,0)],d0=new hn,nl=new le,qd=new le;function Qw(a,e,t){let i=new tv;const s=new yt,o=new yt,u=new sn,c=new dM,d=new hM,h={},p=t.maxTextureSize,g={[vs]:ei,[ei]:vs,[br]:br},_=new qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new yt},radius:{value:4}},vertexShader:$w,fragmentShader:Kw}),S=_.clone();S.defines.HORIZONTAL_PASS=1;const E=new kr;E.setAttribute("position",new ur(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new fr(E,_),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=nc;let y=this.type;this.render=function(L,N,T){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||L.length===0)return;this.type===ty&&(st("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=nc);const D=a.getRenderTarget(),k=a.getActiveCubeFace(),B=a.getActiveMipmapLevel(),Y=a.state;Y.setBlending(Dr),Y.buffers.depth.getReversed()===!0?Y.buffers.color.setClear(0,0,0,0):Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const j=y!==this.type;j&&N.traverse(function(re){re.material&&(Array.isArray(re.material)?re.material.forEach(W=>W.needsUpdate=!0):re.material.needsUpdate=!0)});for(let re=0,W=L.length;re<W;re++){const Q=L[re],V=Q.shadow;if(V===void 0){st("WebGLShadowMap:",Q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const H=V.getFrameExtents();s.multiply(H),o.copy(V.mapSize),(s.x>p||s.y>p)&&(s.x>p&&(o.x=Math.floor(p/H.x),s.x=o.x*H.x,V.mapSize.x=o.x),s.y>p&&(o.y=Math.floor(p/H.y),s.y=o.y*H.y,V.mapSize.y=o.y));const oe=a.state.buffers.depth.getReversed();if(V.camera._reversedDepth=oe,V.map===null||j===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===rl){if(Q.isPointLight){st("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new lr(s.x,s.y,{format:sa,type:Nr,minFilter:On,magFilter:On,generateMipmaps:!1}),V.map.texture.name=Q.name+".shadowMap",V.map.depthTexture=new ro(s.x,s.y,rr),V.map.depthTexture.name=Q.name+".shadowMapDepth",V.map.depthTexture.format=Ur,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Rn,V.map.depthTexture.magFilter=Rn}else Q.isPointLight?(V.map=new lv(s.x),V.map.depthTexture=new aM(s.x,cr)):(V.map=new lr(s.x,s.y),V.map.depthTexture=new ro(s.x,s.y,cr)),V.map.depthTexture.name=Q.name+".shadowMap",V.map.depthTexture.format=Ur,this.type===nc?(V.map.depthTexture.compareFunction=oe?_p:mp,V.map.depthTexture.minFilter=On,V.map.depthTexture.magFilter=On):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Rn,V.map.depthTexture.magFilter=Rn);V.camera.updateProjectionMatrix()}const se=V.map.isWebGLCubeRenderTarget?6:1;for(let F=0;F<se;F++){if(V.map.isWebGLCubeRenderTarget)a.setRenderTarget(V.map,F),a.clear();else{F===0&&(a.setRenderTarget(V.map),a.clear());const K=V.getViewport(F);u.set(o.x*K.x,o.y*K.y,o.x*K.z,o.y*K.w),Y.viewport(u)}if(Q.isPointLight){const K=V.camera,Le=V.matrix,Fe=Q.distance||K.far;Fe!==K.far&&(K.far=Fe,K.updateProjectionMatrix()),nl.setFromMatrixPosition(Q.matrixWorld),K.position.copy(nl),qd.copy(K.position),qd.add(Zw[F]),K.up.copy(jw[F]),K.lookAt(qd),K.updateMatrixWorld(),Le.makeTranslation(-nl.x,-nl.y,-nl.z),d0.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),V._frustum.setFromProjectionMatrix(d0,K.coordinateSystem,K.reversedDepth)}else V.updateMatrices(Q);i=V.getFrustum(),R(N,T,V.camera,Q,this.type)}V.isPointLightShadow!==!0&&this.type===rl&&b(V,T),V.needsUpdate=!1}y=this.type,x.needsUpdate=!1,a.setRenderTarget(D,k,B)};function b(L,N){const T=e.update(M);_.defines.VSM_SAMPLES!==L.blurSamples&&(_.defines.VSM_SAMPLES=L.blurSamples,S.defines.VSM_SAMPLES=L.blurSamples,_.needsUpdate=!0,S.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new lr(s.x,s.y,{format:sa,type:Nr})),_.uniforms.shadow_pass.value=L.map.depthTexture,_.uniforms.resolution.value=L.mapSize,_.uniforms.radius.value=L.radius,a.setRenderTarget(L.mapPass),a.clear(),a.renderBufferDirect(N,null,T,_,M,null),S.uniforms.shadow_pass.value=L.mapPass.texture,S.uniforms.resolution.value=L.mapSize,S.uniforms.radius.value=L.radius,a.setRenderTarget(L.map),a.clear(),a.renderBufferDirect(N,null,T,S,M,null)}function I(L,N,T,D){let k=null;const B=T.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(B!==void 0)k=B;else if(k=T.isPointLight===!0?d:c,a.localClippingEnabled&&N.clipShadows===!0&&Array.isArray(N.clippingPlanes)&&N.clippingPlanes.length!==0||N.displacementMap&&N.displacementScale!==0||N.alphaMap&&N.alphaTest>0||N.map&&N.alphaTest>0||N.alphaToCoverage===!0){const Y=k.uuid,j=N.uuid;let re=h[Y];re===void 0&&(re={},h[Y]=re);let W=re[j];W===void 0&&(W=k.clone(),re[j]=W,N.addEventListener("dispose",P)),k=W}if(k.visible=N.visible,k.wireframe=N.wireframe,D===rl?k.side=N.shadowSide!==null?N.shadowSide:N.side:k.side=N.shadowSide!==null?N.shadowSide:g[N.side],k.alphaMap=N.alphaMap,k.alphaTest=N.alphaToCoverage===!0?.5:N.alphaTest,k.map=N.map,k.clipShadows=N.clipShadows,k.clippingPlanes=N.clippingPlanes,k.clipIntersection=N.clipIntersection,k.displacementMap=N.displacementMap,k.displacementScale=N.displacementScale,k.displacementBias=N.displacementBias,k.wireframeLinewidth=N.wireframeLinewidth,k.linewidth=N.linewidth,T.isPointLight===!0&&k.isMeshDistanceMaterial===!0){const Y=a.properties.get(k);Y.light=T}return k}function R(L,N,T,D,k){if(L.visible===!1)return;if(L.layers.test(N.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&k===rl)&&(!L.frustumCulled||i.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(T.matrixWorldInverse,L.matrixWorld);const j=e.update(L),re=L.material;if(Array.isArray(re)){const W=j.groups;for(let Q=0,V=W.length;Q<V;Q++){const H=W[Q],oe=re[H.materialIndex];if(oe&&oe.visible){const se=I(L,oe,D,k);L.onBeforeShadow(a,L,N,T,j,se,H),a.renderBufferDirect(T,null,j,se,L,H),L.onAfterShadow(a,L,N,T,j,se,H)}}}else if(re.visible){const W=I(L,re,D,k);L.onBeforeShadow(a,L,N,T,j,W,null),a.renderBufferDirect(T,null,j,W,L,null),L.onAfterShadow(a,L,N,T,j,W,null)}}const Y=L.children;for(let j=0,re=Y.length;j<re;j++)R(Y[j],N,T,D,k)}function P(L){L.target.removeEventListener("dispose",P);for(const T in h){const D=h[T],k=L.target.uuid;k in D&&(D[k].dispose(),delete D[k])}}}function Jw(a,e){function t(){let G=!1;const Ae=new sn;let pe=null;const be=new sn(0,0,0,0);return{setMask:function(Ie){pe!==Ie&&!G&&(a.colorMask(Ie,Ie,Ie,Ie),pe=Ie)},setLocked:function(Ie){G=Ie},setClear:function(Ie,ge,We,He,Nt){Nt===!0&&(Ie*=He,ge*=He,We*=He),Ae.set(Ie,ge,We,He),be.equals(Ae)===!1&&(a.clearColor(Ie,ge,We,He),be.copy(Ae))},reset:function(){G=!1,pe=null,be.set(-1,0,0,0)}}}function i(){let G=!1,Ae=!1,pe=null,be=null,Ie=null;return{setReversed:function(ge){if(Ae!==ge){const We=e.get("EXT_clip_control");ge?We.clipControlEXT(We.LOWER_LEFT_EXT,We.ZERO_TO_ONE_EXT):We.clipControlEXT(We.LOWER_LEFT_EXT,We.NEGATIVE_ONE_TO_ONE_EXT),Ae=ge;const He=Ie;Ie=null,this.setClear(He)}},getReversed:function(){return Ae},setTest:function(ge){ge?me(a.DEPTH_TEST):Oe(a.DEPTH_TEST)},setMask:function(ge){pe!==ge&&!G&&(a.depthMask(ge),pe=ge)},setFunc:function(ge){if(Ae&&(ge=Ny[ge]),be!==ge){switch(ge){case rh:a.depthFunc(a.NEVER);break;case sh:a.depthFunc(a.ALWAYS);break;case ah:a.depthFunc(a.LESS);break;case no:a.depthFunc(a.LEQUAL);break;case oh:a.depthFunc(a.EQUAL);break;case lh:a.depthFunc(a.GEQUAL);break;case uh:a.depthFunc(a.GREATER);break;case ch:a.depthFunc(a.NOTEQUAL);break;default:a.depthFunc(a.LEQUAL)}be=ge}},setLocked:function(ge){G=ge},setClear:function(ge){Ie!==ge&&(Ie=ge,Ae&&(ge=1-ge),a.clearDepth(ge))},reset:function(){G=!1,pe=null,be=null,Ie=null,Ae=!1}}}function s(){let G=!1,Ae=null,pe=null,be=null,Ie=null,ge=null,We=null,He=null,Nt=null;return{setTest:function(Rt){G||(Rt?me(a.STENCIL_TEST):Oe(a.STENCIL_TEST))},setMask:function(Rt){Ae!==Rt&&!G&&(a.stencilMask(Rt),Ae=Rt)},setFunc:function(Rt,bn,Si){(pe!==Rt||be!==bn||Ie!==Si)&&(a.stencilFunc(Rt,bn,Si),pe=Rt,be=bn,Ie=Si)},setOp:function(Rt,bn,Si){(ge!==Rt||We!==bn||He!==Si)&&(a.stencilOp(Rt,bn,Si),ge=Rt,We=bn,He=Si)},setLocked:function(Rt){G=Rt},setClear:function(Rt){Nt!==Rt&&(a.clearStencil(Rt),Nt=Rt)},reset:function(){G=!1,Ae=null,pe=null,be=null,Ie=null,ge=null,We=null,He=null,Nt=null}}}const o=new t,u=new i,c=new s,d=new WeakMap,h=new WeakMap;let p={},g={},_={},S=new WeakMap,E=[],M=null,x=!1,y=null,b=null,I=null,R=null,P=null,L=null,N=null,T=new bt(0,0,0),D=0,k=!1,B=null,Y=null,j=null,re=null,W=null;const Q=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,H=0;const oe=a.getParameter(a.VERSION);oe.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(oe)[1]),V=H>=1):oe.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(oe)[1]),V=H>=2);let se=null,F={};const K=a.getParameter(a.SCISSOR_BOX),Le=a.getParameter(a.VIEWPORT),Fe=new sn().fromArray(K),Ue=new sn().fromArray(Le);function ae(G,Ae,pe,be){const Ie=new Uint8Array(4),ge=a.createTexture();a.bindTexture(G,ge),a.texParameteri(G,a.TEXTURE_MIN_FILTER,a.NEAREST),a.texParameteri(G,a.TEXTURE_MAG_FILTER,a.NEAREST);for(let We=0;We<pe;We++)G===a.TEXTURE_3D||G===a.TEXTURE_2D_ARRAY?a.texImage3D(Ae,0,a.RGBA,1,1,be,0,a.RGBA,a.UNSIGNED_BYTE,Ie):a.texImage2D(Ae+We,0,a.RGBA,1,1,0,a.RGBA,a.UNSIGNED_BYTE,Ie);return ge}const ve={};ve[a.TEXTURE_2D]=ae(a.TEXTURE_2D,a.TEXTURE_2D,1),ve[a.TEXTURE_CUBE_MAP]=ae(a.TEXTURE_CUBE_MAP,a.TEXTURE_CUBE_MAP_POSITIVE_X,6),ve[a.TEXTURE_2D_ARRAY]=ae(a.TEXTURE_2D_ARRAY,a.TEXTURE_2D_ARRAY,1,1),ve[a.TEXTURE_3D]=ae(a.TEXTURE_3D,a.TEXTURE_3D,1,1),o.setClear(0,0,0,1),u.setClear(1),c.setClear(0),me(a.DEPTH_TEST),u.setFunc(no),Gt(!1),tn(mg),me(a.CULL_FACE),xt(Dr);function me(G){p[G]!==!0&&(a.enable(G),p[G]=!0)}function Oe(G){p[G]!==!1&&(a.disable(G),p[G]=!1)}function Qe(G,Ae){return _[G]!==Ae?(a.bindFramebuffer(G,Ae),_[G]=Ae,G===a.DRAW_FRAMEBUFFER&&(_[a.FRAMEBUFFER]=Ae),G===a.FRAMEBUFFER&&(_[a.DRAW_FRAMEBUFFER]=Ae),!0):!1}function Je(G,Ae){let pe=E,be=!1;if(G){pe=S.get(Ae),pe===void 0&&(pe=[],S.set(Ae,pe));const Ie=G.textures;if(pe.length!==Ie.length||pe[0]!==a.COLOR_ATTACHMENT0){for(let ge=0,We=Ie.length;ge<We;ge++)pe[ge]=a.COLOR_ATTACHMENT0+ge;pe.length=Ie.length,be=!0}}else pe[0]!==a.BACK&&(pe[0]=a.BACK,be=!0);be&&a.drawBuffers(pe)}function Ht(G){return M!==G?(a.useProgram(G),M=G,!0):!1}const ut={[Ks]:a.FUNC_ADD,[iy]:a.FUNC_SUBTRACT,[ry]:a.FUNC_REVERSE_SUBTRACT};ut[sy]=a.MIN,ut[ay]=a.MAX;const At={[oy]:a.ZERO,[ly]:a.ONE,[uy]:a.SRC_COLOR,[nh]:a.SRC_ALPHA,[my]:a.SRC_ALPHA_SATURATE,[hy]:a.DST_COLOR,[fy]:a.DST_ALPHA,[cy]:a.ONE_MINUS_SRC_COLOR,[ih]:a.ONE_MINUS_SRC_ALPHA,[py]:a.ONE_MINUS_DST_COLOR,[dy]:a.ONE_MINUS_DST_ALPHA,[_y]:a.CONSTANT_COLOR,[gy]:a.ONE_MINUS_CONSTANT_COLOR,[vy]:a.CONSTANT_ALPHA,[xy]:a.ONE_MINUS_CONSTANT_ALPHA};function xt(G,Ae,pe,be,Ie,ge,We,He,Nt,Rt){if(G===Dr){x===!0&&(Oe(a.BLEND),x=!1);return}if(x===!1&&(me(a.BLEND),x=!0),G!==ny){if(G!==y||Rt!==k){if((b!==Ks||P!==Ks)&&(a.blendEquation(a.FUNC_ADD),b=Ks,P=Ks),Rt)switch(G){case Za:a.blendFuncSeparate(a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case _g:a.blendFunc(a.ONE,a.ONE);break;case gg:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case vg:a.blendFuncSeparate(a.DST_COLOR,a.ONE_MINUS_SRC_ALPHA,a.ZERO,a.ONE);break;default:Et("WebGLState: Invalid blending: ",G);break}else switch(G){case Za:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case _g:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE,a.ONE,a.ONE);break;case gg:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case vg:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",G);break}I=null,R=null,L=null,N=null,T.set(0,0,0),D=0,y=G,k=Rt}return}Ie=Ie||Ae,ge=ge||pe,We=We||be,(Ae!==b||Ie!==P)&&(a.blendEquationSeparate(ut[Ae],ut[Ie]),b=Ae,P=Ie),(pe!==I||be!==R||ge!==L||We!==N)&&(a.blendFuncSeparate(At[pe],At[be],At[ge],At[We]),I=pe,R=be,L=ge,N=We),(He.equals(T)===!1||Nt!==D)&&(a.blendColor(He.r,He.g,He.b,Nt),T.copy(He),D=Nt),y=G,k=!1}function mt(G,Ae){G.side===br?Oe(a.CULL_FACE):me(a.CULL_FACE);let pe=G.side===ei;Ae&&(pe=!pe),Gt(pe),G.blending===Za&&G.transparent===!1?xt(Dr):xt(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),u.setFunc(G.depthFunc),u.setTest(G.depthTest),u.setMask(G.depthWrite),o.setMask(G.colorWrite);const be=G.stencilWrite;c.setTest(be),be&&(c.setMask(G.stencilWriteMask),c.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),c.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),$t(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?me(a.SAMPLE_ALPHA_TO_COVERAGE):Oe(a.SAMPLE_ALPHA_TO_COVERAGE)}function Gt(G){B!==G&&(G?a.frontFace(a.CW):a.frontFace(a.CCW),B=G)}function tn(G){G!==JS?(me(a.CULL_FACE),G!==Y&&(G===mg?a.cullFace(a.BACK):G===ey?a.cullFace(a.FRONT):a.cullFace(a.FRONT_AND_BACK))):Oe(a.CULL_FACE),Y=G}function nn(G){G!==j&&(V&&a.lineWidth(G),j=G)}function $t(G,Ae,pe){G?(me(a.POLYGON_OFFSET_FILL),(re!==Ae||W!==pe)&&(re=Ae,W=pe,u.getReversed()&&(Ae=-Ae),a.polygonOffset(Ae,pe))):Oe(a.POLYGON_OFFSET_FILL)}function Pt(G){G?me(a.SCISSOR_TEST):Oe(a.SCISSOR_TEST)}function Wt(G){G===void 0&&(G=a.TEXTURE0+Q-1),se!==G&&(a.activeTexture(G),se=G)}function q(G,Ae,pe){pe===void 0&&(se===null?pe=a.TEXTURE0+Q-1:pe=se);let be=F[pe];be===void 0&&(be={type:void 0,texture:void 0},F[pe]=be),(be.type!==G||be.texture!==Ae)&&(se!==pe&&(a.activeTexture(pe),se=pe),a.bindTexture(G,Ae||ve[G]),be.type=G,be.texture=Ae)}function En(){const G=F[se];G!==void 0&&G.type!==void 0&&(a.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function Tt(){try{a.compressedTexImage2D(...arguments)}catch(G){Et("WebGLState:",G)}}function U(){try{a.compressedTexImage3D(...arguments)}catch(G){Et("WebGLState:",G)}}function w(){try{a.texSubImage2D(...arguments)}catch(G){Et("WebGLState:",G)}}function Z(){try{a.texSubImage3D(...arguments)}catch(G){Et("WebGLState:",G)}}function ie(){try{a.compressedTexSubImage2D(...arguments)}catch(G){Et("WebGLState:",G)}}function fe(){try{a.compressedTexSubImage3D(...arguments)}catch(G){Et("WebGLState:",G)}}function Me(){try{a.texStorage2D(...arguments)}catch(G){Et("WebGLState:",G)}}function Ce(){try{a.texStorage3D(...arguments)}catch(G){Et("WebGLState:",G)}}function de(){try{a.texImage2D(...arguments)}catch(G){Et("WebGLState:",G)}}function _e(){try{a.texImage3D(...arguments)}catch(G){Et("WebGLState:",G)}}function Pe(G){return g[G]!==void 0?g[G]:a.getParameter(G)}function qe(G,Ae){g[G]!==Ae&&(a.pixelStorei(G,Ae),g[G]=Ae)}function De(G){Fe.equals(G)===!1&&(a.scissor(G.x,G.y,G.z,G.w),Fe.copy(G))}function Re(G){Ue.equals(G)===!1&&(a.viewport(G.x,G.y,G.z,G.w),Ue.copy(G))}function je(G,Ae){let pe=h.get(Ae);pe===void 0&&(pe=new WeakMap,h.set(Ae,pe));let be=pe.get(G);be===void 0&&(be=a.getUniformBlockIndex(Ae,G.name),pe.set(G,be))}function et(G,Ae){const be=h.get(Ae).get(G);d.get(Ae)!==be&&(a.uniformBlockBinding(Ae,be,G.__bindingPointIndex),d.set(Ae,be))}function it(){a.disable(a.BLEND),a.disable(a.CULL_FACE),a.disable(a.DEPTH_TEST),a.disable(a.POLYGON_OFFSET_FILL),a.disable(a.SCISSOR_TEST),a.disable(a.STENCIL_TEST),a.disable(a.SAMPLE_ALPHA_TO_COVERAGE),a.blendEquation(a.FUNC_ADD),a.blendFunc(a.ONE,a.ZERO),a.blendFuncSeparate(a.ONE,a.ZERO,a.ONE,a.ZERO),a.blendColor(0,0,0,0),a.colorMask(!0,!0,!0,!0),a.clearColor(0,0,0,0),a.depthMask(!0),a.depthFunc(a.LESS),u.setReversed(!1),a.clearDepth(1),a.stencilMask(4294967295),a.stencilFunc(a.ALWAYS,0,4294967295),a.stencilOp(a.KEEP,a.KEEP,a.KEEP),a.clearStencil(0),a.cullFace(a.BACK),a.frontFace(a.CCW),a.polygonOffset(0,0),a.activeTexture(a.TEXTURE0),a.bindFramebuffer(a.FRAMEBUFFER,null),a.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),a.bindFramebuffer(a.READ_FRAMEBUFFER,null),a.useProgram(null),a.lineWidth(1),a.scissor(0,0,a.canvas.width,a.canvas.height),a.viewport(0,0,a.canvas.width,a.canvas.height),a.pixelStorei(a.PACK_ALIGNMENT,4),a.pixelStorei(a.UNPACK_ALIGNMENT,4),a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,!1),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,a.BROWSER_DEFAULT_WEBGL),a.pixelStorei(a.PACK_ROW_LENGTH,0),a.pixelStorei(a.PACK_SKIP_PIXELS,0),a.pixelStorei(a.PACK_SKIP_ROWS,0),a.pixelStorei(a.UNPACK_ROW_LENGTH,0),a.pixelStorei(a.UNPACK_IMAGE_HEIGHT,0),a.pixelStorei(a.UNPACK_SKIP_PIXELS,0),a.pixelStorei(a.UNPACK_SKIP_ROWS,0),a.pixelStorei(a.UNPACK_SKIP_IMAGES,0),p={},g={},se=null,F={},_={},S=new WeakMap,E=[],M=null,x=!1,y=null,b=null,I=null,R=null,P=null,L=null,N=null,T=new bt(0,0,0),D=0,k=!1,B=null,Y=null,j=null,re=null,W=null,Fe.set(0,0,a.canvas.width,a.canvas.height),Ue.set(0,0,a.canvas.width,a.canvas.height),o.reset(),u.reset(),c.reset()}return{buffers:{color:o,depth:u,stencil:c},enable:me,disable:Oe,bindFramebuffer:Qe,drawBuffers:Je,useProgram:Ht,setBlending:xt,setMaterial:mt,setFlipSided:Gt,setCullFace:tn,setLineWidth:nn,setPolygonOffset:$t,setScissorTest:Pt,activeTexture:Wt,bindTexture:q,unbindTexture:En,compressedTexImage2D:Tt,compressedTexImage3D:U,texImage2D:de,texImage3D:_e,pixelStorei:qe,getParameter:Pe,updateUBOMapping:je,uniformBlockBinding:et,texStorage2D:Me,texStorage3D:Ce,texSubImage2D:w,texSubImage3D:Z,compressedTexSubImage2D:ie,compressedTexSubImage3D:fe,scissor:De,viewport:Re,reset:it}}function eA(a,e,t,i,s,o,u){const c=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new yt,p=new WeakMap,g=new Set;let _;const S=new WeakMap;let E=!1;try{E=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(U,w){return E?new OffscreenCanvas(U,w):_c("canvas")}function x(U,w,Z){let ie=1;const fe=Tt(U);if((fe.width>Z||fe.height>Z)&&(ie=Z/Math.max(fe.width,fe.height)),ie<1)if(typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&U instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&U instanceof ImageBitmap||typeof VideoFrame<"u"&&U instanceof VideoFrame){const Me=Math.floor(ie*fe.width),Ce=Math.floor(ie*fe.height);_===void 0&&(_=M(Me,Ce));const de=w?M(Me,Ce):_;return de.width=Me,de.height=Ce,de.getContext("2d").drawImage(U,0,0,Me,Ce),st("WebGLRenderer: Texture has been resized from ("+fe.width+"x"+fe.height+") to ("+Me+"x"+Ce+")."),de}else return"data"in U&&st("WebGLRenderer: Image in DataTexture is too big ("+fe.width+"x"+fe.height+")."),U;return U}function y(U){return U.generateMipmaps}function b(U){a.generateMipmap(U)}function I(U){return U.isWebGLCubeRenderTarget?a.TEXTURE_CUBE_MAP:U.isWebGL3DRenderTarget?a.TEXTURE_3D:U.isWebGLArrayRenderTarget||U.isCompressedArrayTexture?a.TEXTURE_2D_ARRAY:a.TEXTURE_2D}function R(U,w,Z,ie,fe,Me=!1){if(U!==null){if(a[U]!==void 0)return a[U];st("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+U+"'")}let Ce;ie&&(Ce=e.get("EXT_texture_norm16"),Ce||st("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let de=w;if(w===a.RED&&(Z===a.FLOAT&&(de=a.R32F),Z===a.HALF_FLOAT&&(de=a.R16F),Z===a.UNSIGNED_BYTE&&(de=a.R8),Z===a.UNSIGNED_SHORT&&Ce&&(de=Ce.R16_EXT),Z===a.SHORT&&Ce&&(de=Ce.R16_SNORM_EXT)),w===a.RED_INTEGER&&(Z===a.UNSIGNED_BYTE&&(de=a.R8UI),Z===a.UNSIGNED_SHORT&&(de=a.R16UI),Z===a.UNSIGNED_INT&&(de=a.R32UI),Z===a.BYTE&&(de=a.R8I),Z===a.SHORT&&(de=a.R16I),Z===a.INT&&(de=a.R32I)),w===a.RG&&(Z===a.FLOAT&&(de=a.RG32F),Z===a.HALF_FLOAT&&(de=a.RG16F),Z===a.UNSIGNED_BYTE&&(de=a.RG8),Z===a.UNSIGNED_SHORT&&Ce&&(de=Ce.RG16_EXT),Z===a.SHORT&&Ce&&(de=Ce.RG16_SNORM_EXT)),w===a.RG_INTEGER&&(Z===a.UNSIGNED_BYTE&&(de=a.RG8UI),Z===a.UNSIGNED_SHORT&&(de=a.RG16UI),Z===a.UNSIGNED_INT&&(de=a.RG32UI),Z===a.BYTE&&(de=a.RG8I),Z===a.SHORT&&(de=a.RG16I),Z===a.INT&&(de=a.RG32I)),w===a.RGB_INTEGER&&(Z===a.UNSIGNED_BYTE&&(de=a.RGB8UI),Z===a.UNSIGNED_SHORT&&(de=a.RGB16UI),Z===a.UNSIGNED_INT&&(de=a.RGB32UI),Z===a.BYTE&&(de=a.RGB8I),Z===a.SHORT&&(de=a.RGB16I),Z===a.INT&&(de=a.RGB32I)),w===a.RGBA_INTEGER&&(Z===a.UNSIGNED_BYTE&&(de=a.RGBA8UI),Z===a.UNSIGNED_SHORT&&(de=a.RGBA16UI),Z===a.UNSIGNED_INT&&(de=a.RGBA32UI),Z===a.BYTE&&(de=a.RGBA8I),Z===a.SHORT&&(de=a.RGBA16I),Z===a.INT&&(de=a.RGBA32I)),w===a.RGB&&(Z===a.UNSIGNED_SHORT&&Ce&&(de=Ce.RGB16_EXT),Z===a.SHORT&&Ce&&(de=Ce.RGB16_SNORM_EXT),Z===a.UNSIGNED_INT_5_9_9_9_REV&&(de=a.RGB9_E5),Z===a.UNSIGNED_INT_10F_11F_11F_REV&&(de=a.R11F_G11F_B10F)),w===a.RGBA){const _e=Me?pc:_t.getTransfer(fe);Z===a.FLOAT&&(de=a.RGBA32F),Z===a.HALF_FLOAT&&(de=a.RGBA16F),Z===a.UNSIGNED_BYTE&&(de=_e===It?a.SRGB8_ALPHA8:a.RGBA8),Z===a.UNSIGNED_SHORT&&Ce&&(de=Ce.RGBA16_EXT),Z===a.SHORT&&Ce&&(de=Ce.RGBA16_SNORM_EXT),Z===a.UNSIGNED_SHORT_4_4_4_4&&(de=a.RGBA4),Z===a.UNSIGNED_SHORT_5_5_5_1&&(de=a.RGB5_A1)}return(de===a.R16F||de===a.R32F||de===a.RG16F||de===a.RG32F||de===a.RGBA16F||de===a.RGBA32F)&&e.get("EXT_color_buffer_float"),de}function P(U,w){let Z;return U?w===null||w===cr||w===dl?Z=a.DEPTH24_STENCIL8:w===rr?Z=a.DEPTH32F_STENCIL8:w===fl&&(Z=a.DEPTH24_STENCIL8,st("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):w===null||w===cr||w===dl?Z=a.DEPTH_COMPONENT24:w===rr?Z=a.DEPTH_COMPONENT32F:w===fl&&(Z=a.DEPTH_COMPONENT16),Z}function L(U,w){return y(U)===!0||U.isFramebufferTexture&&U.minFilter!==Rn&&U.minFilter!==On?Math.log2(Math.max(w.width,w.height))+1:U.mipmaps!==void 0&&U.mipmaps.length>0?U.mipmaps.length:U.isCompressedTexture&&Array.isArray(U.image)?w.mipmaps.length:1}function N(U){const w=U.target;w.removeEventListener("dispose",N),D(w),w.isVideoTexture&&p.delete(w),w.isHTMLTexture&&g.delete(w)}function T(U){const w=U.target;w.removeEventListener("dispose",T),B(w)}function D(U){const w=i.get(U);if(w.__webglInit===void 0)return;const Z=U.source,ie=S.get(Z);if(ie){const fe=ie[w.__cacheKey];fe.usedTimes--,fe.usedTimes===0&&k(U),Object.keys(ie).length===0&&S.delete(Z)}i.remove(U)}function k(U){const w=i.get(U);a.deleteTexture(w.__webglTexture);const Z=U.source,ie=S.get(Z);delete ie[w.__cacheKey],u.memory.textures--}function B(U){const w=i.get(U);if(U.depthTexture&&(U.depthTexture.dispose(),i.remove(U.depthTexture)),U.isWebGLCubeRenderTarget)for(let ie=0;ie<6;ie++){if(Array.isArray(w.__webglFramebuffer[ie]))for(let fe=0;fe<w.__webglFramebuffer[ie].length;fe++)a.deleteFramebuffer(w.__webglFramebuffer[ie][fe]);else a.deleteFramebuffer(w.__webglFramebuffer[ie]);w.__webglDepthbuffer&&a.deleteRenderbuffer(w.__webglDepthbuffer[ie])}else{if(Array.isArray(w.__webglFramebuffer))for(let ie=0;ie<w.__webglFramebuffer.length;ie++)a.deleteFramebuffer(w.__webglFramebuffer[ie]);else a.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&a.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&a.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let ie=0;ie<w.__webglColorRenderbuffer.length;ie++)w.__webglColorRenderbuffer[ie]&&a.deleteRenderbuffer(w.__webglColorRenderbuffer[ie]);w.__webglDepthRenderbuffer&&a.deleteRenderbuffer(w.__webglDepthRenderbuffer)}const Z=U.textures;for(let ie=0,fe=Z.length;ie<fe;ie++){const Me=i.get(Z[ie]);Me.__webglTexture&&(a.deleteTexture(Me.__webglTexture),u.memory.textures--),i.remove(Z[ie])}i.remove(U)}let Y=0;function j(){Y=0}function re(){return Y}function W(U){Y=U}function Q(){const U=Y;return U>=s.maxTextures&&st("WebGLTextures: Trying to use "+U+" texture units while this GPU supports only "+s.maxTextures),Y+=1,U}function V(U){const w=[];return w.push(U.wrapS),w.push(U.wrapT),w.push(U.wrapR||0),w.push(U.magFilter),w.push(U.minFilter),w.push(U.anisotropy),w.push(U.internalFormat),w.push(U.format),w.push(U.type),w.push(U.generateMipmaps),w.push(U.premultiplyAlpha),w.push(U.flipY),w.push(U.unpackAlignment),w.push(U.colorSpace),w.join()}function H(U,w){const Z=i.get(U);if(U.isVideoTexture&&q(U),U.isRenderTargetTexture===!1&&U.isExternalTexture!==!0&&U.version>0&&Z.__version!==U.version){const ie=U.image;if(ie===null)st("WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)st("WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(Z,U,w);return}}else U.isExternalTexture&&(Z.__webglTexture=U.sourceTexture?U.sourceTexture:null);t.bindTexture(a.TEXTURE_2D,Z.__webglTexture,a.TEXTURE0+w)}function oe(U,w){const Z=i.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&Z.__version!==U.version){Oe(Z,U,w);return}else U.isExternalTexture&&(Z.__webglTexture=U.sourceTexture?U.sourceTexture:null);t.bindTexture(a.TEXTURE_2D_ARRAY,Z.__webglTexture,a.TEXTURE0+w)}function se(U,w){const Z=i.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&Z.__version!==U.version){Oe(Z,U,w);return}t.bindTexture(a.TEXTURE_3D,Z.__webglTexture,a.TEXTURE0+w)}function F(U,w){const Z=i.get(U);if(U.isCubeDepthTexture!==!0&&U.version>0&&Z.__version!==U.version){Qe(Z,U,w);return}t.bindTexture(a.TEXTURE_CUBE_MAP,Z.__webglTexture,a.TEXTURE0+w)}const K={[fh]:a.REPEAT,[Pr]:a.CLAMP_TO_EDGE,[dh]:a.MIRRORED_REPEAT},Le={[Rn]:a.NEAREST,[My]:a.NEAREST_MIPMAP_NEAREST,[Du]:a.NEAREST_MIPMAP_LINEAR,[On]:a.LINEAR,[gd]:a.LINEAR_MIPMAP_NEAREST,[js]:a.LINEAR_MIPMAP_LINEAR},Fe={[wy]:a.NEVER,[Py]:a.ALWAYS,[Ay]:a.LESS,[mp]:a.LEQUAL,[Ry]:a.EQUAL,[_p]:a.GEQUAL,[Cy]:a.GREATER,[by]:a.NOTEQUAL};function Ue(U,w){if(w.type===rr&&e.has("OES_texture_float_linear")===!1&&(w.magFilter===On||w.magFilter===gd||w.magFilter===Du||w.magFilter===js||w.minFilter===On||w.minFilter===gd||w.minFilter===Du||w.minFilter===js)&&st("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),a.texParameteri(U,a.TEXTURE_WRAP_S,K[w.wrapS]),a.texParameteri(U,a.TEXTURE_WRAP_T,K[w.wrapT]),(U===a.TEXTURE_3D||U===a.TEXTURE_2D_ARRAY)&&a.texParameteri(U,a.TEXTURE_WRAP_R,K[w.wrapR]),a.texParameteri(U,a.TEXTURE_MAG_FILTER,Le[w.magFilter]),a.texParameteri(U,a.TEXTURE_MIN_FILTER,Le[w.minFilter]),w.compareFunction&&(a.texParameteri(U,a.TEXTURE_COMPARE_MODE,a.COMPARE_REF_TO_TEXTURE),a.texParameteri(U,a.TEXTURE_COMPARE_FUNC,Fe[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(w.magFilter===Rn||w.minFilter!==Du&&w.minFilter!==js||w.type===rr&&e.has("OES_texture_float_linear")===!1)return;if(w.anisotropy>1||i.get(w).__currentAnisotropy){const Z=e.get("EXT_texture_filter_anisotropic");a.texParameterf(U,Z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,s.getMaxAnisotropy())),i.get(w).__currentAnisotropy=w.anisotropy}}}function ae(U,w){let Z=!1;U.__webglInit===void 0&&(U.__webglInit=!0,w.addEventListener("dispose",N));const ie=w.source;let fe=S.get(ie);fe===void 0&&(fe={},S.set(ie,fe));const Me=V(w);if(Me!==U.__cacheKey){fe[Me]===void 0&&(fe[Me]={texture:a.createTexture(),usedTimes:0},u.memory.textures++,Z=!0),fe[Me].usedTimes++;const Ce=fe[U.__cacheKey];Ce!==void 0&&(fe[U.__cacheKey].usedTimes--,Ce.usedTimes===0&&k(w)),U.__cacheKey=Me,U.__webglTexture=fe[Me].texture}return Z}function ve(U,w,Z){return Math.floor(Math.floor(U/Z)/w)}function me(U,w,Z,ie){const Me=U.updateRanges;if(Me.length===0)t.texSubImage2D(a.TEXTURE_2D,0,0,0,w.width,w.height,Z,ie,w.data);else{Me.sort((qe,De)=>qe.start-De.start);let Ce=0;for(let qe=1;qe<Me.length;qe++){const De=Me[Ce],Re=Me[qe],je=De.start+De.count,et=ve(Re.start,w.width,4),it=ve(De.start,w.width,4);Re.start<=je+1&&et===it&&ve(Re.start+Re.count-1,w.width,4)===et?De.count=Math.max(De.count,Re.start+Re.count-De.start):(++Ce,Me[Ce]=Re)}Me.length=Ce+1;const de=t.getParameter(a.UNPACK_ROW_LENGTH),_e=t.getParameter(a.UNPACK_SKIP_PIXELS),Pe=t.getParameter(a.UNPACK_SKIP_ROWS);t.pixelStorei(a.UNPACK_ROW_LENGTH,w.width);for(let qe=0,De=Me.length;qe<De;qe++){const Re=Me[qe],je=Math.floor(Re.start/4),et=Math.ceil(Re.count/4),it=je%w.width,G=Math.floor(je/w.width),Ae=et,pe=1;t.pixelStorei(a.UNPACK_SKIP_PIXELS,it),t.pixelStorei(a.UNPACK_SKIP_ROWS,G),t.texSubImage2D(a.TEXTURE_2D,0,it,G,Ae,pe,Z,ie,w.data)}U.clearUpdateRanges(),t.pixelStorei(a.UNPACK_ROW_LENGTH,de),t.pixelStorei(a.UNPACK_SKIP_PIXELS,_e),t.pixelStorei(a.UNPACK_SKIP_ROWS,Pe)}}function Oe(U,w,Z){let ie=a.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(ie=a.TEXTURE_2D_ARRAY),w.isData3DTexture&&(ie=a.TEXTURE_3D);const fe=ae(U,w),Me=w.source;t.bindTexture(ie,U.__webglTexture,a.TEXTURE0+Z);const Ce=i.get(Me);if(Me.version!==Ce.__version||fe===!0){if(t.activeTexture(a.TEXTURE0+Z),(typeof ImageBitmap<"u"&&w.image instanceof ImageBitmap)===!1){const pe=_t.getPrimaries(_t.workingColorSpace),be=w.colorSpace===fs?null:_t.getPrimaries(w.colorSpace),Ie=w.colorSpace===fs||pe===be?a.NONE:a.BROWSER_DEFAULT_WEBGL;t.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,w.flipY),t.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),t.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ie)}t.pixelStorei(a.UNPACK_ALIGNMENT,w.unpackAlignment);let _e=x(w.image,!1,s.maxTextureSize);_e=En(w,_e);const Pe=o.convert(w.format,w.colorSpace),qe=o.convert(w.type);let De=R(w.internalFormat,Pe,qe,w.normalized,w.colorSpace,w.isVideoTexture);Ue(ie,w);let Re;const je=w.mipmaps,et=w.isVideoTexture!==!0,it=Ce.__version===void 0||fe===!0,G=Me.dataReady,Ae=L(w,_e);if(w.isDepthTexture)De=P(w.format===Qs,w.type),it&&(et?t.texStorage2D(a.TEXTURE_2D,1,De,_e.width,_e.height):t.texImage2D(a.TEXTURE_2D,0,De,_e.width,_e.height,0,Pe,qe,null));else if(w.isDataTexture)if(je.length>0){et&&it&&t.texStorage2D(a.TEXTURE_2D,Ae,De,je[0].width,je[0].height);for(let pe=0,be=je.length;pe<be;pe++)Re=je[pe],et?G&&t.texSubImage2D(a.TEXTURE_2D,pe,0,0,Re.width,Re.height,Pe,qe,Re.data):t.texImage2D(a.TEXTURE_2D,pe,De,Re.width,Re.height,0,Pe,qe,Re.data);w.generateMipmaps=!1}else et?(it&&t.texStorage2D(a.TEXTURE_2D,Ae,De,_e.width,_e.height),G&&me(w,_e,Pe,qe)):t.texImage2D(a.TEXTURE_2D,0,De,_e.width,_e.height,0,Pe,qe,_e.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){et&&it&&t.texStorage3D(a.TEXTURE_2D_ARRAY,Ae,De,je[0].width,je[0].height,_e.depth);for(let pe=0,be=je.length;pe<be;pe++)if(Re=je[pe],w.format!==Yi)if(Pe!==null)if(et){if(G)if(w.layerUpdates.size>0){const Ie=Gg(Re.width,Re.height,w.format,w.type);for(const ge of w.layerUpdates){const We=Re.data.subarray(ge*Ie/Re.data.BYTES_PER_ELEMENT,(ge+1)*Ie/Re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,pe,0,0,ge,Re.width,Re.height,1,Pe,We)}w.clearLayerUpdates()}else t.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,pe,0,0,0,Re.width,Re.height,_e.depth,Pe,Re.data)}else t.compressedTexImage3D(a.TEXTURE_2D_ARRAY,pe,De,Re.width,Re.height,_e.depth,0,Re.data,0,0);else st("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else et?G&&t.texSubImage3D(a.TEXTURE_2D_ARRAY,pe,0,0,0,Re.width,Re.height,_e.depth,Pe,qe,Re.data):t.texImage3D(a.TEXTURE_2D_ARRAY,pe,De,Re.width,Re.height,_e.depth,0,Pe,qe,Re.data)}else{et&&it&&t.texStorage2D(a.TEXTURE_2D,Ae,De,je[0].width,je[0].height);for(let pe=0,be=je.length;pe<be;pe++)Re=je[pe],w.format!==Yi?Pe!==null?et?G&&t.compressedTexSubImage2D(a.TEXTURE_2D,pe,0,0,Re.width,Re.height,Pe,Re.data):t.compressedTexImage2D(a.TEXTURE_2D,pe,De,Re.width,Re.height,0,Re.data):st("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):et?G&&t.texSubImage2D(a.TEXTURE_2D,pe,0,0,Re.width,Re.height,Pe,qe,Re.data):t.texImage2D(a.TEXTURE_2D,pe,De,Re.width,Re.height,0,Pe,qe,Re.data)}else if(w.isDataArrayTexture)if(et){if(it&&t.texStorage3D(a.TEXTURE_2D_ARRAY,Ae,De,_e.width,_e.height,_e.depth),G)if(w.layerUpdates.size>0){const pe=Gg(_e.width,_e.height,w.format,w.type);for(const be of w.layerUpdates){const Ie=_e.data.subarray(be*pe/_e.data.BYTES_PER_ELEMENT,(be+1)*pe/_e.data.BYTES_PER_ELEMENT);t.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,be,_e.width,_e.height,1,Pe,qe,Ie)}w.clearLayerUpdates()}else t.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,0,_e.width,_e.height,_e.depth,Pe,qe,_e.data)}else t.texImage3D(a.TEXTURE_2D_ARRAY,0,De,_e.width,_e.height,_e.depth,0,Pe,qe,_e.data);else if(w.isData3DTexture)et?(it&&t.texStorage3D(a.TEXTURE_3D,Ae,De,_e.width,_e.height,_e.depth),G&&t.texSubImage3D(a.TEXTURE_3D,0,0,0,0,_e.width,_e.height,_e.depth,Pe,qe,_e.data)):t.texImage3D(a.TEXTURE_3D,0,De,_e.width,_e.height,_e.depth,0,Pe,qe,_e.data);else if(w.isFramebufferTexture){if(it)if(et)t.texStorage2D(a.TEXTURE_2D,Ae,De,_e.width,_e.height);else{let pe=_e.width,be=_e.height;for(let Ie=0;Ie<Ae;Ie++)t.texImage2D(a.TEXTURE_2D,Ie,De,pe,be,0,Pe,qe,null),pe>>=1,be>>=1}}else if(w.isHTMLTexture){if("texElementImage2D"in a){const pe=a.canvas;if(pe.hasAttribute("layoutsubtree")||pe.setAttribute("layoutsubtree","true"),_e.parentNode!==pe){pe.appendChild(_e),g.add(w),pe.onpaint=be=>{const Ie=be.changedElements;for(const ge of g)Ie.includes(ge.image)&&(ge.needsUpdate=!0)},pe.requestPaint();return}if(a.texElementImage2D.length===3)a.texElementImage2D(a.TEXTURE_2D,a.RGBA8,_e);else{const Ie=a.RGBA,ge=a.RGBA,We=a.UNSIGNED_BYTE;a.texElementImage2D(a.TEXTURE_2D,0,Ie,ge,We,_e)}a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE)}}else if(je.length>0){if(et&&it){const pe=Tt(je[0]);t.texStorage2D(a.TEXTURE_2D,Ae,De,pe.width,pe.height)}for(let pe=0,be=je.length;pe<be;pe++)Re=je[pe],et?G&&t.texSubImage2D(a.TEXTURE_2D,pe,0,0,Pe,qe,Re):t.texImage2D(a.TEXTURE_2D,pe,De,Pe,qe,Re);w.generateMipmaps=!1}else if(et){if(it){const pe=Tt(_e);t.texStorage2D(a.TEXTURE_2D,Ae,De,pe.width,pe.height)}G&&t.texSubImage2D(a.TEXTURE_2D,0,0,0,Pe,qe,_e)}else t.texImage2D(a.TEXTURE_2D,0,De,Pe,qe,_e);y(w)&&b(ie),Ce.__version=Me.version,w.onUpdate&&w.onUpdate(w)}U.__version=w.version}function Qe(U,w,Z){if(w.image.length!==6)return;const ie=ae(U,w),fe=w.source;t.bindTexture(a.TEXTURE_CUBE_MAP,U.__webglTexture,a.TEXTURE0+Z);const Me=i.get(fe);if(fe.version!==Me.__version||ie===!0){t.activeTexture(a.TEXTURE0+Z);const Ce=_t.getPrimaries(_t.workingColorSpace),de=w.colorSpace===fs?null:_t.getPrimaries(w.colorSpace),_e=w.colorSpace===fs||Ce===de?a.NONE:a.BROWSER_DEFAULT_WEBGL;t.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,w.flipY),t.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),t.pixelStorei(a.UNPACK_ALIGNMENT,w.unpackAlignment),t.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);const Pe=w.isCompressedTexture||w.image[0].isCompressedTexture,qe=w.image[0]&&w.image[0].isDataTexture,De=[];for(let ge=0;ge<6;ge++)!Pe&&!qe?De[ge]=x(w.image[ge],!0,s.maxCubemapSize):De[ge]=qe?w.image[ge].image:w.image[ge],De[ge]=En(w,De[ge]);const Re=De[0],je=o.convert(w.format,w.colorSpace),et=o.convert(w.type),it=R(w.internalFormat,je,et,w.normalized,w.colorSpace),G=w.isVideoTexture!==!0,Ae=Me.__version===void 0||ie===!0,pe=fe.dataReady;let be=L(w,Re);Ue(a.TEXTURE_CUBE_MAP,w);let Ie;if(Pe){G&&Ae&&t.texStorage2D(a.TEXTURE_CUBE_MAP,be,it,Re.width,Re.height);for(let ge=0;ge<6;ge++){Ie=De[ge].mipmaps;for(let We=0;We<Ie.length;We++){const He=Ie[We];w.format!==Yi?je!==null?G?pe&&t.compressedTexSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We,0,0,He.width,He.height,je,He.data):t.compressedTexImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We,it,He.width,He.height,0,He.data):st("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?pe&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We,0,0,He.width,He.height,je,et,He.data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We,it,He.width,He.height,0,je,et,He.data)}}}else{if(Ie=w.mipmaps,G&&Ae){Ie.length>0&&be++;const ge=Tt(De[0]);t.texStorage2D(a.TEXTURE_CUBE_MAP,be,it,ge.width,ge.height)}for(let ge=0;ge<6;ge++)if(qe){G?pe&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,De[ge].width,De[ge].height,je,et,De[ge].data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,it,De[ge].width,De[ge].height,0,je,et,De[ge].data);for(let We=0;We<Ie.length;We++){const Nt=Ie[We].image[ge].image;G?pe&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We+1,0,0,Nt.width,Nt.height,je,et,Nt.data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We+1,it,Nt.width,Nt.height,0,je,et,Nt.data)}}else{G?pe&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,je,et,De[ge]):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,it,je,et,De[ge]);for(let We=0;We<Ie.length;We++){const He=Ie[We];G?pe&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We+1,0,0,je,et,He.image[ge]):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,We+1,it,je,et,He.image[ge])}}}y(w)&&b(a.TEXTURE_CUBE_MAP),Me.__version=fe.version,w.onUpdate&&w.onUpdate(w)}U.__version=w.version}function Je(U,w,Z,ie,fe,Me){const Ce=o.convert(Z.format,Z.colorSpace),de=o.convert(Z.type),_e=R(Z.internalFormat,Ce,de,Z.normalized,Z.colorSpace),Pe=i.get(w),qe=i.get(Z);if(qe.__renderTarget=w,!Pe.__hasExternalTextures){const De=Math.max(1,w.width>>Me),Re=Math.max(1,w.height>>Me);fe===a.TEXTURE_3D||fe===a.TEXTURE_2D_ARRAY?t.texImage3D(fe,Me,_e,De,Re,w.depth,0,Ce,de,null):t.texImage2D(fe,Me,_e,De,Re,0,Ce,de,null)}t.bindFramebuffer(a.FRAMEBUFFER,U),Wt(w)?c.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,ie,fe,qe.__webglTexture,0,Pt(w)):(fe===a.TEXTURE_2D||fe>=a.TEXTURE_CUBE_MAP_POSITIVE_X&&fe<=a.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&a.framebufferTexture2D(a.FRAMEBUFFER,ie,fe,qe.__webglTexture,Me),t.bindFramebuffer(a.FRAMEBUFFER,null)}function Ht(U,w,Z){if(a.bindRenderbuffer(a.RENDERBUFFER,U),w.depthBuffer){const ie=w.depthTexture,fe=ie&&ie.isDepthTexture?ie.type:null,Me=P(w.stencilBuffer,fe),Ce=w.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;Wt(w)?c.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,Pt(w),Me,w.width,w.height):Z?a.renderbufferStorageMultisample(a.RENDERBUFFER,Pt(w),Me,w.width,w.height):a.renderbufferStorage(a.RENDERBUFFER,Me,w.width,w.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,Ce,a.RENDERBUFFER,U)}else{const ie=w.textures;for(let fe=0;fe<ie.length;fe++){const Me=ie[fe],Ce=o.convert(Me.format,Me.colorSpace),de=o.convert(Me.type),_e=R(Me.internalFormat,Ce,de,Me.normalized,Me.colorSpace);Wt(w)?c.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,Pt(w),_e,w.width,w.height):Z?a.renderbufferStorageMultisample(a.RENDERBUFFER,Pt(w),_e,w.width,w.height):a.renderbufferStorage(a.RENDERBUFFER,_e,w.width,w.height)}}a.bindRenderbuffer(a.RENDERBUFFER,null)}function ut(U,w,Z){const ie=w.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(a.FRAMEBUFFER,U),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const fe=i.get(w.depthTexture);if(fe.__renderTarget=w,(!fe.__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),ie){if(fe.__webglInit===void 0&&(fe.__webglInit=!0,w.depthTexture.addEventListener("dispose",N)),fe.__webglTexture===void 0){fe.__webglTexture=a.createTexture(),t.bindTexture(a.TEXTURE_CUBE_MAP,fe.__webglTexture),Ue(a.TEXTURE_CUBE_MAP,w.depthTexture);const Pe=o.convert(w.depthTexture.format),qe=o.convert(w.depthTexture.type);let De;w.depthTexture.format===Ur?De=a.DEPTH_COMPONENT24:w.depthTexture.format===Qs&&(De=a.DEPTH24_STENCIL8);for(let Re=0;Re<6;Re++)a.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Re,0,De,w.width,w.height,0,Pe,qe,null)}}else H(w.depthTexture,0);const Me=fe.__webglTexture,Ce=Pt(w),de=ie?a.TEXTURE_CUBE_MAP_POSITIVE_X+Z:a.TEXTURE_2D,_e=w.depthTexture.format===Qs?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;if(w.depthTexture.format===Ur)Wt(w)?c.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,_e,de,Me,0,Ce):a.framebufferTexture2D(a.FRAMEBUFFER,_e,de,Me,0);else if(w.depthTexture.format===Qs)Wt(w)?c.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,_e,de,Me,0,Ce):a.framebufferTexture2D(a.FRAMEBUFFER,_e,de,Me,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function At(U){const w=i.get(U),Z=U.isWebGLCubeRenderTarget===!0;if(w.__boundDepthTexture!==U.depthTexture){const ie=U.depthTexture;if(w.__depthDisposeCallback&&w.__depthDisposeCallback(),ie){const fe=()=>{delete w.__boundDepthTexture,delete w.__depthDisposeCallback,ie.removeEventListener("dispose",fe)};ie.addEventListener("dispose",fe),w.__depthDisposeCallback=fe}w.__boundDepthTexture=ie}if(U.depthTexture&&!w.__autoAllocateDepthBuffer)if(Z)for(let ie=0;ie<6;ie++)ut(w.__webglFramebuffer[ie],U,ie);else{const ie=U.texture.mipmaps;ie&&ie.length>0?ut(w.__webglFramebuffer[0],U,0):ut(w.__webglFramebuffer,U,0)}else if(Z){w.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)if(t.bindFramebuffer(a.FRAMEBUFFER,w.__webglFramebuffer[ie]),w.__webglDepthbuffer[ie]===void 0)w.__webglDepthbuffer[ie]=a.createRenderbuffer(),Ht(w.__webglDepthbuffer[ie],U,!1);else{const fe=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Me=w.__webglDepthbuffer[ie];a.bindRenderbuffer(a.RENDERBUFFER,Me),a.framebufferRenderbuffer(a.FRAMEBUFFER,fe,a.RENDERBUFFER,Me)}}else{const ie=U.texture.mipmaps;if(ie&&ie.length>0?t.bindFramebuffer(a.FRAMEBUFFER,w.__webglFramebuffer[0]):t.bindFramebuffer(a.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer===void 0)w.__webglDepthbuffer=a.createRenderbuffer(),Ht(w.__webglDepthbuffer,U,!1);else{const fe=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Me=w.__webglDepthbuffer;a.bindRenderbuffer(a.RENDERBUFFER,Me),a.framebufferRenderbuffer(a.FRAMEBUFFER,fe,a.RENDERBUFFER,Me)}}t.bindFramebuffer(a.FRAMEBUFFER,null)}function xt(U,w,Z){const ie=i.get(U);w!==void 0&&Je(ie.__webglFramebuffer,U,U.texture,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,0),Z!==void 0&&At(U)}function mt(U){const w=U.texture,Z=i.get(U),ie=i.get(w);U.addEventListener("dispose",T);const fe=U.textures,Me=U.isWebGLCubeRenderTarget===!0,Ce=fe.length>1;if(Ce||(ie.__webglTexture===void 0&&(ie.__webglTexture=a.createTexture()),ie.__version=w.version,u.memory.textures++),Me){Z.__webglFramebuffer=[];for(let de=0;de<6;de++)if(w.mipmaps&&w.mipmaps.length>0){Z.__webglFramebuffer[de]=[];for(let _e=0;_e<w.mipmaps.length;_e++)Z.__webglFramebuffer[de][_e]=a.createFramebuffer()}else Z.__webglFramebuffer[de]=a.createFramebuffer()}else{if(w.mipmaps&&w.mipmaps.length>0){Z.__webglFramebuffer=[];for(let de=0;de<w.mipmaps.length;de++)Z.__webglFramebuffer[de]=a.createFramebuffer()}else Z.__webglFramebuffer=a.createFramebuffer();if(Ce)for(let de=0,_e=fe.length;de<_e;de++){const Pe=i.get(fe[de]);Pe.__webglTexture===void 0&&(Pe.__webglTexture=a.createTexture(),u.memory.textures++)}if(U.samples>0&&Wt(U)===!1){Z.__webglMultisampledFramebuffer=a.createFramebuffer(),Z.__webglColorRenderbuffer=[],t.bindFramebuffer(a.FRAMEBUFFER,Z.__webglMultisampledFramebuffer);for(let de=0;de<fe.length;de++){const _e=fe[de];Z.__webglColorRenderbuffer[de]=a.createRenderbuffer(),a.bindRenderbuffer(a.RENDERBUFFER,Z.__webglColorRenderbuffer[de]);const Pe=o.convert(_e.format,_e.colorSpace),qe=o.convert(_e.type),De=R(_e.internalFormat,Pe,qe,_e.normalized,_e.colorSpace,U.isXRRenderTarget===!0),Re=Pt(U);a.renderbufferStorageMultisample(a.RENDERBUFFER,Re,De,U.width,U.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+de,a.RENDERBUFFER,Z.__webglColorRenderbuffer[de])}a.bindRenderbuffer(a.RENDERBUFFER,null),U.depthBuffer&&(Z.__webglDepthRenderbuffer=a.createRenderbuffer(),Ht(Z.__webglDepthRenderbuffer,U,!0)),t.bindFramebuffer(a.FRAMEBUFFER,null)}}if(Me){t.bindTexture(a.TEXTURE_CUBE_MAP,ie.__webglTexture),Ue(a.TEXTURE_CUBE_MAP,w);for(let de=0;de<6;de++)if(w.mipmaps&&w.mipmaps.length>0)for(let _e=0;_e<w.mipmaps.length;_e++)Je(Z.__webglFramebuffer[de][_e],U,w,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+de,_e);else Je(Z.__webglFramebuffer[de],U,w,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);y(w)&&b(a.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let de=0,_e=fe.length;de<_e;de++){const Pe=fe[de],qe=i.get(Pe);let De=a.TEXTURE_2D;(U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(De=U.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),t.bindTexture(De,qe.__webglTexture),Ue(De,Pe),Je(Z.__webglFramebuffer,U,Pe,a.COLOR_ATTACHMENT0+de,De,0),y(Pe)&&b(De)}t.unbindTexture()}else{let de=a.TEXTURE_2D;if((U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(de=U.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),t.bindTexture(de,ie.__webglTexture),Ue(de,w),w.mipmaps&&w.mipmaps.length>0)for(let _e=0;_e<w.mipmaps.length;_e++)Je(Z.__webglFramebuffer[_e],U,w,a.COLOR_ATTACHMENT0,de,_e);else Je(Z.__webglFramebuffer,U,w,a.COLOR_ATTACHMENT0,de,0);y(w)&&b(de),t.unbindTexture()}U.depthBuffer&&At(U)}function Gt(U){const w=U.textures;for(let Z=0,ie=w.length;Z<ie;Z++){const fe=w[Z];if(y(fe)){const Me=I(U),Ce=i.get(fe).__webglTexture;t.bindTexture(Me,Ce),b(Me),t.unbindTexture()}}}const tn=[],nn=[];function $t(U){if(U.samples>0){if(Wt(U)===!1){const w=U.textures,Z=U.width,ie=U.height;let fe=a.COLOR_BUFFER_BIT;const Me=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Ce=i.get(U),de=w.length>1;if(de)for(let Pe=0;Pe<w.length;Pe++)t.bindFramebuffer(a.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Pe,a.RENDERBUFFER,null),t.bindFramebuffer(a.FRAMEBUFFER,Ce.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Pe,a.TEXTURE_2D,null,0);t.bindFramebuffer(a.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer);const _e=U.texture.mipmaps;_e&&_e.length>0?t.bindFramebuffer(a.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer[0]):t.bindFramebuffer(a.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Pe=0;Pe<w.length;Pe++){if(U.resolveDepthBuffer&&(U.depthBuffer&&(fe|=a.DEPTH_BUFFER_BIT),U.stencilBuffer&&U.resolveStencilBuffer&&(fe|=a.STENCIL_BUFFER_BIT)),de){a.framebufferRenderbuffer(a.READ_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.RENDERBUFFER,Ce.__webglColorRenderbuffer[Pe]);const qe=i.get(w[Pe]).__webglTexture;a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,qe,0)}a.blitFramebuffer(0,0,Z,ie,0,0,Z,ie,fe,a.NEAREST),d===!0&&(tn.length=0,nn.length=0,tn.push(a.COLOR_ATTACHMENT0+Pe),U.depthBuffer&&U.resolveDepthBuffer===!1&&(tn.push(Me),nn.push(Me),a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,nn)),a.invalidateFramebuffer(a.READ_FRAMEBUFFER,tn))}if(t.bindFramebuffer(a.READ_FRAMEBUFFER,null),t.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),de)for(let Pe=0;Pe<w.length;Pe++){t.bindFramebuffer(a.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Pe,a.RENDERBUFFER,Ce.__webglColorRenderbuffer[Pe]);const qe=i.get(w[Pe]).__webglTexture;t.bindFramebuffer(a.FRAMEBUFFER,Ce.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Pe,a.TEXTURE_2D,qe,0)}t.bindFramebuffer(a.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(U.depthBuffer&&U.resolveDepthBuffer===!1&&d){const w=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,[w])}}}function Pt(U){return Math.min(s.maxSamples,U.samples)}function Wt(U){const w=i.get(U);return U.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function q(U){const w=u.render.frame;p.get(U)!==w&&(p.set(U,w),U.update())}function En(U,w){const Z=U.colorSpace,ie=U.format,fe=U.type;return U.isCompressedTexture===!0||U.isVideoTexture===!0||Z!==hc&&Z!==fs&&(_t.getTransfer(Z)===It?(ie!==Yi||fe!==Pi)&&st("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",Z)),w}function Tt(U){return typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement?(h.width=U.naturalWidth||U.width,h.height=U.naturalHeight||U.height):typeof VideoFrame<"u"&&U instanceof VideoFrame?(h.width=U.displayWidth,h.height=U.displayHeight):(h.width=U.width,h.height=U.height),h}this.allocateTextureUnit=Q,this.resetTextureUnits=j,this.getTextureUnits=re,this.setTextureUnits=W,this.setTexture2D=H,this.setTexture2DArray=oe,this.setTexture3D=se,this.setTextureCube=F,this.rebindTextures=xt,this.setupRenderTarget=mt,this.updateRenderTargetMipmap=Gt,this.updateMultisampleRenderTarget=$t,this.setupDepthRenderbuffer=At,this.setupFrameBufferTexture=Je,this.useMultisampledRTT=Wt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function tA(a,e){function t(i,s=fs){let o;const u=_t.getTransfer(s);if(i===Pi)return a.UNSIGNED_BYTE;if(i===cp)return a.UNSIGNED_SHORT_4_4_4_4;if(i===fp)return a.UNSIGNED_SHORT_5_5_5_1;if(i===G0)return a.UNSIGNED_INT_5_9_9_9_REV;if(i===W0)return a.UNSIGNED_INT_10F_11F_11F_REV;if(i===V0)return a.BYTE;if(i===H0)return a.SHORT;if(i===fl)return a.UNSIGNED_SHORT;if(i===up)return a.INT;if(i===cr)return a.UNSIGNED_INT;if(i===rr)return a.FLOAT;if(i===Nr)return a.HALF_FLOAT;if(i===X0)return a.ALPHA;if(i===Y0)return a.RGB;if(i===Yi)return a.RGBA;if(i===Ur)return a.DEPTH_COMPONENT;if(i===Qs)return a.DEPTH_STENCIL;if(i===q0)return a.RED;if(i===dp)return a.RED_INTEGER;if(i===sa)return a.RG;if(i===hp)return a.RG_INTEGER;if(i===pp)return a.RGBA_INTEGER;if(i===ic||i===rc||i===sc||i===ac)if(u===It)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(i===ic)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===rc)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===sc)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ac)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(i===ic)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===rc)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===sc)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ac)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===hh||i===ph||i===mh||i===_h)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(i===hh)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ph)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===mh)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===_h)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===gh||i===vh||i===xh||i===Sh||i===yh||i===fc||i===Mh)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(i===gh||i===vh)return u===It?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(i===xh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC;if(i===Sh)return o.COMPRESSED_R11_EAC;if(i===yh)return o.COMPRESSED_SIGNED_R11_EAC;if(i===fc)return o.COMPRESSED_RG11_EAC;if(i===Mh)return o.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Eh||i===Th||i===wh||i===Ah||i===Rh||i===Ch||i===bh||i===Ph||i===Dh||i===Lh||i===Ih||i===Nh||i===Uh||i===Fh)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(i===Eh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Th)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===wh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Ah)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Rh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ch)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===bh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ph)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Dh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Lh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Ih)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Nh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Uh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Fh)return u===It?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Oh||i===kh||i===Bh)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(i===Oh)return u===It?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===kh)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Bh)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===zh||i===Vh||i===dc||i===Hh)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(i===zh)return o.COMPRESSED_RED_RGTC1_EXT;if(i===Vh)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===dc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Hh)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===dl?a.UNSIGNED_INT_24_8:a[i]!==void 0?a[i]:null}return{convert:t}}const nA=`
void main() {
...
*/var y0,ps,eo,Np,Js,M0,Up,lR=function(){return typeof window<"u"},Or={},$s=180/Math.PI,to=Math.PI/180,qa=Math.atan2,E0=1e8,Fp=/([A-Z])/g,uR=/(left|right|width|margin|padding|x)/i,cR=/[\s,\(]\S/,ar={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},np=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},fR=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},dR=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},hR=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},pR=function(e,t){var i=t.s+t.c*e;t.set(t.t,t.p,~~(i+(i<0?-.5:.5))+t.u,t)},Jv=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},ex=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},mR=function(e,t,i){return e.style[t]=i},_R=function(e,t,i){return e.style.setProperty(t,i)},gR=function(e,t,i){return e._gsap[t]=i},vR=function(e,t,i){return e._gsap.scaleX=e._gsap.scaleY=i},xR=function(e,t,i,s,o){var u=e._gsap;u.scaleX=u.scaleY=i,u.renderTransform(o,u)},SR=function(e,t,i,s,o){var u=e._gsap;u[t]=i,u.renderTransform(o,u)},en="transform",ri=en+"Origin",yR=function a(e,t){var i=this,s=this.target,o=s.style,u=s._gsap;if(e in Or&&o){if(this.tfm=this.tfm||{},e!=="transform")e=ar[e]||e,~e.indexOf(",")?e.split(",").forEach(function(c){return i.tfm[c]=Cr(s,c)}):this.tfm[e]=u.x?u[e]:Cr(s,e),e===ri&&(this.tfm.zOrigin=u.zOrigin);else return ar.transform.split(",").forEach(function(c){return a.call(i,c,t)});if(this.props.indexOf(en)>=0)return;u.svg&&(this.svgo=s.getAttribute("data-svg-origin"),this.props.push(ri,t,"")),e=en}(o||t)&&this.props.push(e,t,o[e])},tx=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},MR=function(){var e=this.props,t=this.target,i=t.style,s=t._gsap,o,u;for(o=0;o<e.length;o+=3)e[o+1]?e[o+1]===2?t[e[o]](e[o+2]):t[e[o]]=e[o+2]:e[o+2]?i[e[o]]=e[o+2]:i.removeProperty(e[o].substr(0,2)==="--"?e[o]:e[o].replace(Fp,"-$1").toLowerCase());if(this.tfm){for(u in this.tfm)s[u]=this.tfm[u];s.svg&&(s.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),o=Up(),(!o||!o.isStart)&&!i[en]&&(tx(i),s.zOrigin&&i[ri]&&(i[ri]+=" "+s.zOrigin+"px",s.zOrigin=0,s.renderTransform()),s.uncache=1)}},nx=function(e,t){var i={target:e,props:[],revert:MR,save:yR};return e._gsap||si.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(s){return i.save(s)}),i},ix,ip=function(e,t){var i=ps.createElementNS?ps.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):ps.createElement(e);return i&&i.style?i:ps.createElement(e)},mi=function a(e,t,i){var s=getComputedStyle(e);return s[t]||s.getPropertyValue(t.replace(Fp,"-$1").toLowerCase())||s.getPropertyValue(t)||!i&&a(e,co(t)||t,1)||""},T0="O,Moz,ms,Ms,Webkit".split(","),co=function(e,t,i){var s=t||Js,o=s.style,u=5;if(e in o&&!i)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);u--&&!(T0[u]+e in o););return u<0?null:(u===3?"ms":u>=0?T0[u]:"")+e},rp=function(){lR()&&window.document&&(y0=window,ps=y0.document,eo=ps.documentElement,Js=ip("div")||{style:{}},ip("div"),en=co(en),ri=en+"Origin",Js.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",ix=!!co("perspective"),Up=si.core.reverting,Np=1)},w0=function(e){var t=e.ownerSVGElement,i=ip("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),s=e.cloneNode(!0),o;s.style.display="block",i.appendChild(s),eo.appendChild(i);try{o=s.getBBox()}catch{}return i.removeChild(s),eo.removeChild(i),o},A0=function(e,t){for(var i=t.length;i--;)if(e.hasAttribute(t[i]))return e.getAttribute(t[i])},rx=function(e){var t,i;try{t=e.getBBox()}catch{t=w0(e),i=1}return t&&(t.width||t.height)||i||(t=w0(e)),t&&!t.width&&!t.x&&!t.y?{x:+A0(e,["x","cx","x1"])||0,y:+A0(e,["y","cy","y1"])||0,width:0,height:0}:t},sx=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&rx(e))},Ss=function(e,t){if(t){var i=e.style,s;t in Or&&t!==ri&&(t=en),i.removeProperty?(s=t.substr(0,2),(s==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),i.removeProperty(s==="--"?t:t.replace(Fp,"-$1").toLowerCase())):i.removeAttribute(t)}},ms=function(e,t,i,s,o,u){var c=new ii(e._pt,t,i,0,1,u?ex:Jv);return e._pt=c,c.b=s,c.e=o,e._props.push(i),c},R0={deg:1,rad:1,turn:1},ER={grid:1,flex:1},ys=function a(e,t,i,s){var o=parseFloat(i)||0,u=(i+"").trim().substr((o+"").length)||"px",c=Js.style,d=uR.test(t),h=e.tagName.toLowerCase()==="svg",p=(h?"client":"offset")+(d?"Width":"Height"),g=100,_=s==="px",S=s==="%",E,M,x,y;if(s===u||!o||R0[s]||R0[u])return o;if(u!=="px"&&!_&&(o=a(e,t,i,"px")),y=e.getCTM&&sx(e),(S||u==="%")&&(Or[t]||~t.indexOf("adius")))return E=y?e.getBBox()[d?"width":"height"]:e[p],ln(S?o/E*g:o/100*E);if(c[d?"width":"height"]=g+(_?u:s),M=s!=="rem"&&~t.indexOf("adius")||s==="em"&&e.appendChild&&!h?e:e.parentNode,y&&(M=(e.ownerSVGElement||{}).parentNode),(!M||M===ps||!M.appendChild)&&(M=ps.body),x=M._gsap,x&&S&&x.width&&d&&x.time===hi.time&&!x.uncache)return ln(o/x.width*g);if(S&&(t==="height"||t==="width")){var b=e.style[t];e.style[t]=g+s,E=e[p],b?e.style[t]=b:Ss(e,t)}else(S||u==="%")&&!ER[mi(M,"display")]&&(c.position=mi(e,"position")),M===e&&(c.position="static"),M.appendChild(Js),E=Js[p],M.removeChild(Js),c.position="absolute";return d&&S&&(x=ea(M),x.time=hi.time,x.width=M[p]),ln(_?E*o/g:E&&o?g/E*o:0)},Cr=function(e,t,i,s){var o;return Np||rp(),t in ar&&t!=="transform"&&(t=ar[t],~t.indexOf(",")&&(t=t.split(",")[0])),Or[t]&&t!=="transform"?(o=Sl(e,s),o=t!=="transformOrigin"?o[t]:o.svg?o.origin:Ec(mi(e,ri))+" "+o.zOrigin+"px"):(o=e.style[t],(!o||o==="auto"||s||~(o+"").indexOf("calc("))&&(o=Mc[t]&&Mc[t](e,t,i)||mi(e,t)||Ev(e,t)||(t==="opacity"?1:0))),i&&!~(o+"").trim().indexOf(" ")?ys(e,t,o,i)+i:o},TR=function(e,t,i,s){if(!i||i==="none"){var o=co(t,e,1),u=o&&mi(e,o,1);u&&u!==i?(t=o,i=u):t==="borderColor"&&(i=mi(e,"borderTopColor"))}var c=new ii(this._pt,e.style,t,0,1,Zv),d=0,h=0,p,g,_,S,E,M,x,y,b,I,R,P;if(c.b=i,c.e=s,i+="",s+="",s.substring(0,6)==="var(--"&&(s=mi(e,s.substring(4,s.indexOf(")")))),s==="auto"&&(M=e.style[t],e.style[t]=s,s=mi(e,t)||s,M?e.style[t]=M:Ss(e,t)),p=[i,s],Hv(p),i=p[0],s=p[1],_=i.match($a)||[],P=s.match($a)||[],P.length){for(;g=$a.exec(s);)x=g[0],b=s.substring(d,g.index),E?E=(E+1)%5:(b.substr(-5)==="rgba("||b.substr(-5)==="hsla(")&&(E=1),x!==(M=_[h++]||"")&&(S=parseFloat(M)||0,R=M.substr((S+"").length),x.charAt(1)==="="&&(x=Ja(S,x)+R),y=parseFloat(x),I=x.substr((y+"").length),d=$a.lastIndex-I.length,I||(I=I||gi.units[t]||R,d===s.length&&(s+=I,c.e+=I)),R!==I&&(S=ys(e,t,M,I)||0),c._pt={_next:c._pt,p:b||h===1?b:",",s:S,c:y-S,m:E&&E<4||t==="zIndex"?Math.round:0});c.c=d<s.length?s.substring(d,s.length):""}else c.r=t==="display"&&s==="none"?ex:Jv;return vv.test(s)&&(c.e=0),this._pt=c,c},C0={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},wR=function(e){var t=e.split(" "),i=t[0],s=t[1]||"50%";return(i==="top"||i==="bottom"||s==="left"||s==="right")&&(e=i,i=s,s=e),t[0]=C0[i]||i,t[1]=C0[s]||s,t.join(" ")},AR=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var i=t.t,s=i.style,o=t.u,u=i._gsap,c,d,h;if(o==="all"||o===!0)s.cssText="",d=1;else for(o=o.split(","),h=o.length;--h>-1;)c=o[h],Or[c]&&(d=1,c=c==="transformOrigin"?ri:en),Ss(i,c);d&&(Ss(i,en),u&&(u.svg&&i.removeAttribute("transform"),s.scale=s.rotate=s.translate="none",Sl(i,1),u.uncache=1,tx(s)))}},Mc={clearProps:function(e,t,i,s,o){if(o.data!=="isFromStart"){var u=e._pt=new ii(e._pt,t,i,0,0,AR);return u.u=s,u.pr=-10,u.tween=o,e._props.push(i),1}}},xl=[1,0,0,1,0,0],ax={},ox=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},b0=function(e){var t=mi(e,en);return ox(t)?xl:t.substr(7).match(gv).map(ln)},Op=function(e,t){var i=e._gsap||ea(e),s=e.style,o=b0(e),u,c,d,h;return i.svg&&e.getAttribute("transform")?(d=e.transform.baseVal.consolidate().matrix,o=[d.a,d.b,d.c,d.d,d.e,d.f],o.join(",")==="1,0,0,1,0,0"?xl:o):(o===xl&&!e.offsetParent&&e!==eo&&!i.svg&&(d=s.display,s.display="block",u=e.parentNode,(!u||!e.offsetParent&&!e.getBoundingClientRect().width)&&(h=1,c=e.nextElementSibling,eo.appendChild(e)),o=b0(e),d?s.display=d:Ss(e,"display"),h&&(c?u.insertBefore(e,c):u?u.appendChild(e):eo.removeChild(e))),t&&o.length>6?[o[0],o[1],o[4],o[5],o[12],o[13]]:o)},sp=function(e,t,i,s,o,u){var c=e._gsap,d=o||Op(e,!0),h=c.xOrigin||0,p=c.yOrigin||0,g=c.xOffset||0,_=c.yOffset||0,S=d[0],E=d[1],M=d[2],x=d[3],y=d[4],b=d[5],I=t.split(" "),R=parseFloat(I[0])||0,P=parseFloat(I[1])||0,L,N,T,D;i?d!==xl&&(N=S*x-E*M)&&(T=R*(x/N)+P*(-M/N)+(M*b-x*y)/N,D=R*(-E/N)+P*(S/N)-(S*b-E*y)/N,R=T,P=D):(L=rx(e),R=L.x+(~I[0].indexOf("%")?R/100*L.width:R),P=L.y+(~(I[1]||I[0]).indexOf("%")?P/100*L.height:P)),s||s!==!1&&c.smooth?(y=R-h,b=P-p,c.xOffset=g+(y*S+b*M)-y,c.yOffset=_+(y*E+b*x)-b):c.xOffset=c.yOffset=0,c.xOrigin=R,c.yOrigin=P,c.smooth=!!s,c.origin=t,c.originIsAbsolute=!!i,e.style[ri]="0px 0px",u&&(ms(u,c,"xOrigin",h,R),ms(u,c,"yOrigin",p,P),ms(u,c,"xOffset",g,c.xOffset),ms(u,c,"yOffset",_,c.yOffset)),e.setAttribute("data-svg-origin",R+" "+P)},Sl=function(e,t){var i=e._gsap||new Wv(e);if("x"in i&&!t&&!i.uncache)return i;var s=e.style,o=i.scaleX<0,u="px",c="deg",d=getComputedStyle(e),h=mi(e,ri)||"0",p,g,_,S,E,M,x,y,b,I,R,P,L,N,T,D,k,B,Y,j,re,W,Q,V,H,oe,se,F,K,Le,Fe,Ue;return p=g=_=M=x=y=b=I=R=0,S=E=1,i.svg=!!(e.getCTM&&sx(e)),d.translate&&((d.translate!=="none"||d.scale!=="none"||d.rotate!=="none")&&(s[en]=(d.translate!=="none"?"translate3d("+(d.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(d.rotate!=="none"?"rotate("+d.rotate+") ":"")+(d.scale!=="none"?"scale("+d.scale.split(" ").join(",")+") ":"")+(d[en]!=="none"?d[en]:"")),s.scale=s.rotate=s.translate="none"),N=Op(e,i.svg),i.svg&&(i.uncache?(H=e.getBBox(),h=i.xOrigin-H.x+"px "+(i.yOrigin-H.y)+"px",V=""):V=!t&&e.getAttribute("data-svg-origin"),sp(e,V||h,!!V||i.originIsAbsolute,i.smooth!==!1,N)),P=i.xOrigin||0,L=i.yOrigin||0,N!==xl&&(B=N[0],Y=N[1],j=N[2],re=N[3],p=W=N[4],g=Q=N[5],N.length===6?(S=Math.sqrt(B*B+Y*Y),E=Math.sqrt(re*re+j*j),M=B||Y?qa(Y,B)*$s:0,b=j||re?qa(j,re)*$s+M:0,b&&(E*=Math.abs(Math.cos(b*to))),i.svg&&(p-=P-(P*B+L*j),g-=L-(P*Y+L*re))):(Ue=N[6],Le=N[7],se=N[8],F=N[9],K=N[10],Fe=N[11],p=N[12],g=N[13],_=N[14],T=qa(Ue,K),x=T*$s,T&&(D=Math.cos(-T),k=Math.sin(-T),V=W*D+se*k,H=Q*D+F*k,oe=Ue*D+K*k,se=W*-k+se*D,F=Q*-k+F*D,K=Ue*-k+K*D,Fe=Le*-k+Fe*D,W=V,Q=H,Ue=oe),T=qa(-j,K),y=T*$s,T&&(D=Math.cos(-T),k=Math.sin(-T),V=B*D-se*k,H=Y*D-F*k,oe=j*D-K*k,Fe=re*k+Fe*D,B=V,Y=H,j=oe),T=qa(Y,B),M=T*$s,T&&(D=Math.cos(T),k=Math.sin(T),V=B*D+Y*k,H=W*D+Q*k,Y=Y*D-B*k,Q=Q*D-W*k,B=V,W=H),x&&Math.abs(x)+Math.abs(M)>359.9&&(x=M=0,y=180-y),S=ln(Math.sqrt(B*B+Y*Y+j*j)),E=ln(Math.sqrt(Q*Q+Ue*Ue)),T=qa(W,Q),b=Math.abs(T)>2e-4?T*$s:0,R=Fe?1/(Fe<0?-Fe:Fe):0),i.svg&&(V=e.getAttribute("transform"),i.forceCSS=e.setAttribute("transform","")||!ox(mi(e,en)),V&&e.setAttribute("transform",V))),Math.abs(b)>90&&Math.abs(b)<270&&(o?(S*=-1,b+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,b+=b<=0?180:-180)),t=t||i.uncache,i.x=p-((i.xPercent=p&&(!t&&i.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-p)?-50:0)))?e.offsetWidth*i.xPercent/100:0)+u,i.y=g-((i.yPercent=g&&(!t&&i.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-g)?-50:0)))?e.offsetHeight*i.yPercent/100:0)+u,i.z=_+u,i.scaleX=ln(S),i.scaleY=ln(E),i.rotation=ln(M)+c,i.rotationX=ln(x)+c,i.rotationY=ln(y)+c,i.skewX=b+c,i.skewY=I+c,i.transformPerspective=R+u,(i.zOrigin=parseFloat(h.split(" ")[2])||!t&&i.zOrigin||0)&&(s[ri]=Ec(h)),i.xOffset=i.yOffset=0,i.force3D=gi.force3D,i.renderTransform=i.svg?CR:ix?lx:RR,i.uncache=0,i},Ec=function(e){return(e=e.split(" "))[0]+" "+e[1]},th=function(e,t,i){var s=Fn(t);return ln(parseFloat(t)+parseFloat(ys(e,"x",i+"px",s)))+s},RR=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,lx(e,t)},Xs="0deg",il="0px",Ys=") ",lx=function(e,t){var i=t||this,s=i.xPercent,o=i.yPercent,u=i.x,c=i.y,d=i.z,h=i.rotation,p=i.rotationY,g=i.rotationX,_=i.skewX,S=i.skewY,E=i.scaleX,M=i.scaleY,x=i.transformPerspective,y=i.force3D,b=i.target,I=i.zOrigin,R="",P=y==="auto"&&e&&e!==1||y===!0;if(I&&(g!==Xs||p!==Xs)){var L=parseFloat(p)*to,N=Math.sin(L),T=Math.cos(L),D;L=parseFloat(g)*to,D=Math.cos(L),u=th(b,u,N*D*-I),c=th(b,c,-Math.sin(L)*-I),d=th(b,d,T*D*-I+I)}x!==il&&(R+="perspective("+x+Ys),(s||o)&&(R+="translate("+s+"%, "+o+"%) "),(P||u!==il||c!==il||d!==il)&&(R+=d!==il||P?"translate3d("+u+", "+c+", "+d+") ":"translate("+u+", "+c+Ys),h!==Xs&&(R+="rotate("+h+Ys),p!==Xs&&(R+="rotateY("+p+Ys),g!==Xs&&(R+="rotateX("+g+Ys),(_!==Xs||S!==Xs)&&(R+="skew("+_+", "+S+Ys),(E!==1||M!==1)&&(R+="scale("+E+", "+M+Ys),b.style[en]=R||"translate(0, 0)"},CR=function(e,t){var i=t||this,s=i.xPercent,o=i.yPercent,u=i.x,c=i.y,d=i.rotation,h=i.skewX,p=i.skewY,g=i.scaleX,_=i.scaleY,S=i.target,E=i.xOrigin,M=i.yOrigin,x=i.xOffset,y=i.yOffset,b=i.forceCSS,I=parseFloat(u),R=parseFloat(c),P,L,N,T,D;d=parseFloat(d),h=parseFloat(h),p=parseFloat(p),p&&(p=parseFloat(p),h+=p,d+=p),d||h?(d*=to,h*=to,P=Math.cos(d)*g,L=Math.sin(d)*g,N=Math.sin(d-h)*-_,T=Math.cos(d-h)*_,h&&(p*=to,D=Math.tan(h-p),D=Math.sqrt(1+D*D),N*=D,T*=D,p&&(D=Math.tan(p),D=Math.sqrt(1+D*D),P*=D,L*=D)),P=ln(P),L=ln(L),N=ln(N),T=ln(T)):(P=g,T=_,L=N=0),(I&&!~(u+"").indexOf("px")||R&&!~(c+"").indexOf("px"))&&(I=ys(S,"x",u,"px"),R=ys(S,"y",c,"px")),(E||M||x||y)&&(I=ln(I+E-(E*P+M*N)+x),R=ln(R+M-(E*L+M*T)+y)),(s||o)&&(D=S.getBBox(),I=ln(I+s/100*D.width),R=ln(R+o/100*D.height)),D="matrix("+P+","+L+","+N+","+T+","+I+","+R+")",S.setAttribute("transform",D),b&&(S.style[en]=D)},bR=function(e,t,i,s,o){var u=360,c=Mn(o),d=parseFloat(o)*(c&&~o.indexOf("rad")?$s:1),h=d-s,p=s+h+"deg",g,_;return c&&(g=o.split("_")[1],g==="short"&&(h%=u,h!==h%(u/2)&&(h+=h<0?u:-u)),g==="cw"&&h<0?h=(h+u*E0)%u-~~(h/u)*u:g==="ccw"&&h>0&&(h=(h-u*E0)%u-~~(h/u)*u)),e._pt=_=new ii(e._pt,t,i,s,h,fR),_.e=p,_.u="deg",e._props.push(i),_},P0=function(e,t){for(var i in t)e[i]=t[i];return e},PR=function(e,t,i){var s=P0({},i._gsap),o="perspective,force3D,transformOrigin,svgOrigin",u=i.style,c,d,h,p,g,_,S,E;s.svg?(h=i.getAttribute("transform"),i.setAttribute("transform",""),u[en]=t,c=Sl(i,1),Ss(i,en),i.setAttribute("transform",h)):(h=getComputedStyle(i)[en],u[en]=t,c=Sl(i,1),u[en]=h);for(d in Or)h=s[d],p=c[d],h!==p&&o.indexOf(d)<0&&(S=Fn(h),E=Fn(p),g=S!==E?ys(i,d,h,E):parseFloat(h),_=parseFloat(p),e._pt=new ii(e._pt,c,d,g,_-g,np),e._pt.u=E||0,e._props.push(d));P0(c,s)};ni("padding,margin,Width,Radius",function(a,e){var t="Top",i="Right",s="Bottom",o="Left",u=(e<3?[t,i,s,o]:[t+o,t+i,s+i,s+o]).map(function(c){return e<2?a+c:"border"+c+a});Mc[e>1?"border"+a:a]=function(c,d,h,p,g){var _,S;if(arguments.length<4)return _=u.map(function(E){return Cr(c,E,h)}),S=_.join(" "),S.split(_[0]).length===5?_[0]:S;_=(p+"").split(" "),S={},u.forEach(function(E,M){return S[E]=_[M]=_[M]||_[(M-1)/2|0]}),c.init(d,S,g)}});var ux={name:"css",register:rp,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,i,s,o){var u=this._props,c=e.style,d=i.vars.startAt,h,p,g,_,S,E,M,x,y,b,I,R,P,L,N,T,D;Np||rp(),this.styles=this.styles||nx(e),T=this.styles.props,this.tween=i;for(M in t)if(M!=="autoRound"&&(p=t[M],!(di[M]&&Xv(M,t,i,s,e,o)))){if(S=typeof p,E=Mc[M],S==="function"&&(p=p.call(i,s,e,o),S=typeof p),S==="string"&&~p.indexOf("random(")&&(p=_l(p)),E)E(this,e,M,p,i)&&(N=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(e).getPropertyValue(M)+"").trim(),p+="",gs.lastIndex=0,gs.test(h)||(x=Fn(h),y=Fn(p),y?x!==y&&(h=ys(e,M,h,y)+y):x&&(p+=x)),this.add(c,"setProperty",h,p,s,o,0,0,M),u.push(M),T.push(M,0,c[M]);else if(S!=="undefined"){if(d&&M in d?(h=typeof d[M]=="function"?d[M].call(i,s,e,o):d[M],Mn(h)&&~h.indexOf("random(")&&(h=_l(h)),Fn(h+"")||h==="auto"||(h+=gi.units[M]||Fn(Cr(e,M))||""),(h+"").charAt(1)==="="&&(h=Cr(e,M))):h=Cr(e,M),_=parseFloat(h),b=S==="string"&&p.charAt(1)==="="&&p.substr(0,2),b&&(p=p.substr(2)),g=parseFloat(p),M in ar&&(M==="autoAlpha"&&(_===1&&Cr(e,"visibility")==="hidden"&&g&&(_=0),T.push("visibility",0,c.visibility),ms(this,c,"visibility",_?"inherit":"hidden",g?"inherit":"hidden",!g)),M!=="scale"&&M!=="transform"&&(M=ar[M],~M.indexOf(",")&&(M=M.split(",")[0]))),I=M in Or,I){if(this.styles.save(M),D=p,S==="string"&&p.substring(0,6)==="var(--"){if(p=mi(e,p.substring(4,p.indexOf(")"))),p.substring(0,5)==="calc("){var k=e.style.perspective;e.style.perspective=p,p=mi(e,"perspective"),k?e.style.perspective=k:Ss(e,"perspective")}g=parseFloat(p)}if(R||(P=e._gsap,P.renderTransform&&!t.parseTransform||Sl(e,t.parseTransform),L=t.smoothOrigin!==!1&&P.smooth,R=this._pt=new ii(this._pt,c,en,0,1,P.renderTransform,P,0,-1),R.dep=1),M==="scale")this._pt=new ii(this._pt,P,"scaleY",P.scaleY,(b?Ja(P.scaleY,b+g):g)-P.scaleY||0,np),this._pt.u=0,u.push("scaleY",M),M+="X";else if(M==="transformOrigin"){T.push(ri,0,c[ri]),p=wR(p),P.svg?sp(e,p,0,L,0,this):(y=parseFloat(p.split(" ")[2])||0,y!==P.zOrigin&&ms(this,P,"zOrigin",P.zOrigin,y),ms(this,c,M,Ec(h),Ec(p)));continue}else if(M==="svgOrigin"){sp(e,p,1,L,0,this);continue}else if(M in ax){bR(this,P,M,_,b?Ja(_,b+p):p);continue}else if(M==="smoothOrigin"){ms(this,P,"smooth",P.smooth,p);continue}else if(M==="force3D"){P[M]=p;continue}else if(M==="transform"){PR(this,p,e);continue}}else M in c||(M=co(M)||M);if(I||(g||g===0)&&(_||_===0)&&!cR.test(p)&&M in c)x=(h+"").substr((_+"").length),g||(g=0),y=Fn(p)||(M in gi.units?gi.units[M]:x),x!==y&&(_=ys(e,M,h,y)),this._pt=new ii(this._pt,I?P:c,M,_,(b?Ja(_,b+g):g)-_,!I&&(y==="px"||M==="zIndex")&&t.autoRound!==!1?pR:np),this._pt.u=y||0,I&&D!==p?(this._pt.b=h,this._pt.e=D,this._pt.r=hR):x!==y&&y!=="%"&&(this._pt.b=h,this._pt.r=dR);else if(M in c)TR.call(this,e,M,h,b?b+p:p);else if(M in e)this.add(e,M,h||e[M],b?b+p:p,s,o);else if(M!=="parseTransform"){Tp(M,p);continue}I||(M in c?T.push(M,0,c[M]):typeof e[M]=="function"?T.push(M,2,e[M]()):T.push(M,1,h||e[M])),u.push(M)}}N&&jv(this)},render:function(e,t){if(t.tween._time||!Up())for(var i=t._pt;i;)i.r(e,i.d),i=i._next;else t.styles.revert()},get:Cr,aliases:ar,getSetter:function(e,t,i){var s=ar[t];return s&&s.indexOf(",")<0&&(t=s),t in Or&&t!==ri&&(e._gsap.x||Cr(e,"x"))?i&&M0===i?t==="scale"?vR:gR:(M0=i||{})&&(t==="scale"?xR:SR):e.style&&!yp(e.style[t])?mR:~t.indexOf("-")?_R:Lp(e,t)},core:{_removeProperty:Ss,_getMatrix:Op}};si.utils.checkPrefix=co;si.core.getStyleSaver=nx;(function(a,e,t,i){var s=ni(a+","+e+","+t,function(o){Or[o]=1});ni(e,function(o){gi.units[o]="deg",ax[o]=1}),ar[s[13]]=a+","+e,ni(i,function(o){var u=o.split(":");ar[u[1]]=s[u[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ni("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(a){gi.units[a]="px"});si.registerPlugin(ux);var cs=si.registerPlugin(ux)||si;cs.core.Tween;const DR=(a,e)=>{const t=e.x-a.x,i=e.y-a.y;return Math.sqrt(t*t+i*i)},tc=(a,e,t,i)=>{const s=i-Math.abs(i*a/e);return Math.max(t,s+t)},LR=(a,e)=>{let t;return(...i)=>{clearTimeout(t),t=setTimeout(()=>a(...i),e)}};function D0({text:a="Compressa",fontFamily:e="Roboto Flex",fontUrl:t="https://fonts.googleapis.com/css2?family=Roboto+Flex:opsz,wdth,wght@8..144,25..151,100..1000&display=swap",width:i=!0,weight:s=!0,italic:o=!1,alpha:u=!1,flex:c=!0,stroke:d=!1,scale:h=!1,textColor:p="#FFFFFF",strokeColor:g="#FFFFFF",className:_="",minFontSize:S=24}){const E=pt.useRef(null),M=pt.useRef(null),x=pt.useRef([]),y=pt.useRef({x:0,y:0}),b=pt.useRef({x:0,y:0}),[I,R]=pt.useState(S),[P,L]=pt.useState(1),[N,T]=pt.useState(1),D=pt.useMemo(()=>a.split(""),[a]);pt.useEffect(()=>{const j=W=>{b.current.x=W.clientX,b.current.y=W.clientY},re=W=>{const Q=W.touches[0];Q&&(b.current.x=Q.clientX,b.current.y=Q.clientY)};if(window.addEventListener("mousemove",j),window.addEventListener("touchmove",re,{passive:!0}),E.current){const{left:W,top:Q,width:V,height:H}=E.current.getBoundingClientRect();y.current.x=W+V/2,y.current.y=Q+H/2,b.current.x=y.current.x,b.current.y=y.current.y}return()=>{window.removeEventListener("mousemove",j),window.removeEventListener("touchmove",re)}},[]);const k=pt.useCallback(()=>{if(!E.current||!M.current)return;const{width:j,height:re}=E.current.getBoundingClientRect(),W=Math.max(j/Math.max(D.length/1.65,1),S);R(W),L(1),T(1),requestAnimationFrame(()=>{if(!M.current)return;const Q=M.current.getBoundingClientRect();if(h&&Q.height>0){const V=re/Q.height;L(V),T(V)}})},[D.length,S,h]);pt.useEffect(()=>{const j=LR(k,100);return j(),window.addEventListener("resize",j),()=>window.removeEventListener("resize",j)},[k]),pt.useEffect(()=>{let j=0;const re=()=>{if(y.current.x+=(b.current.x-y.current.x)/14,y.current.y+=(b.current.y-y.current.y)/14,M.current){const W=M.current.getBoundingClientRect(),Q=Math.max(W.width*.42,1);x.current.forEach(V=>{if(!V)return;const H=V.getBoundingClientRect(),oe={x:H.x+H.width/2,y:H.y+H.height/2},se=DR(y.current,oe),F=i?Math.floor(tc(se,Q,18,154)):100,K=s?Math.floor(tc(se,Q,180,820)):520,Le=o?tc(se,Q,0,1).toFixed(2):0,Fe=u?tc(se,Q,.15,.85).toFixed(2):1,Ue=i?Math.max(.82,Math.min(1.18,F/100)):1,ae=`'wght' ${K}, 'wdth' ${F}, 'ital' ${Le}`;V.style.fontVariationSettings!==ae&&(V.style.fontVariationSettings=ae),V.style.transform=`scaleX(${Ue.toFixed(3)})`,u&&V.style.opacity!==Fe&&(V.style.opacity=Fe)})}j=requestAnimationFrame(re)};return re(),()=>cancelAnimationFrame(j)},[i,s,o,u]);const B=pt.useMemo(()=>he.jsx("style",{children:`
      ...
      `}),[t,g,p]),Y=[_,c?"text-pressure-flex":"",d?"text-pressure-stroke":""].filter(Boolean).join(" ");return he.jsxs("div",{ref:E,className:"text-pressure-shell",children:[B,he.jsx("h1",{ref:M,className:`text-pressure-title ${Y}`,style:{fontFamily:e,textTransform:"uppercase",fontSize:I,lineHeight:N,transform:`scale(1, ${P})`,transformOrigin:"center top",margin:0,textAlign:"center",userSelect:"none",whiteSpace:"nowrap",fontWeight:100,width:"100%"},children:D.map((j,re)=>he.jsx("span",{ref:W=>{x.current[re]=W},"data-char":j,style:{display:"inline-block",color:d?void 0:p,transformOrigin:"50% 60%",transition:"color 180ms ease",willChange:"transform, font-variation-settings"},children:j===" "?" ":j},`${j}-${re}`))})]})}const ap=window.STUDIO_DATA||{featured:[],portfolio:[]},Al=(a="")=>!a||/^(https?:|data:|blob:)/i.test(a)?a:`/heangeun/${String(a).replace(/^\/+/,"")}`;function IR(){const[a,e]=pt.useState(0),[t,i]=pt.useState(!1),[s,o]=pt.useState(!0);return pt.useEffect(()=>{const u=performance.now(),c=1180;let d=0;const h=p=>{const g=p-u,_=Math.min(g/c,1),S=1-Math.pow(1-_,3),E=_<.94?Math.sin(p*.055)*2.6+Math.sin(p*.017)*1.4:0,M=Math.max(0,Math.min(100,Math.floor(S*100+E)));e(M),_<1?d=requestAnimationFrame(h):(e(100),window.setTimeout(()=>i(!0),180),window.setTimeout(()=>o(!1),820))};return d=requestAnimationFrame(h),()=>cancelAnimationFrame(d)},[]),s?he.jsxs("div",{className:`loading-intro${t?" is-done":""}`,"aria-label":"LOADING",children:[he.jsxs("div",{className:"loading-symbols","aria-hidden":"true",children:[he.jsx("span",{children:"+"}),he.jsx("span",{children:"%"}),he.jsx("span",{children:"+"}),he.jsx("span",{children:"/"})]}),he.jsxs("div",{className:"loading-count",children:[he.jsx("span",{children:String(a).padStart(2,"0")}),he.jsx("em",{children:"%"})]}),he.jsx("div",{className:"loading-track","aria-hidden":"true",children:he.jsx("span",{style:{transform:`scaleX(${a/100})`}})})]}):null}function NR(){pt.useEffect(()=>{const a=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.16});return document.querySelectorAll(".reveal").forEach(e=>a.observe(e)),()=>a.disconnect()},[])}function UR(){pt.useEffect(()=>{let a=0;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const t=()=>{const i=window.innerHeight||1;document.querySelectorAll(".scroll-motion").forEach(s=>{const o=s.getBoundingClientRect(),u=o.top+o.height/2,c=Math.max(-1,Math.min(1,(u-i/2)/i)),d=Number(s.dataset.depth||0);s.style.setProperty("--scroll-y",`${(c*-44+d*14).toFixed(2)}px`),s.style.setProperty("--scroll-scale",`${(1.015-Math.abs(c)*.045).toFixed(3)}`)}),a=requestAnimationFrame(t)};return a=requestAnimationFrame(t),()=>cancelAnimationFrame(a)},[])}function FR(){const a=pt.useRef(null);return pt.useEffect(()=>{const e=a.current;if(!e||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const i=e.getContext("2d",{alpha:!0}),s=[];let o=0,u=0,c=0,d=0;const h=()=>{const g=e.parentElement.getBoundingClientRect(),_=1;o=Math.max(1,g.width),u=Math.max(1,g.height),e.width=Math.floor(o*_),e.height=Math.floor(u*_),e.style.width=`${o}px`,e.style.height=`${u}px`,i.setTransform(_,0,0,_,0,0),s.length=0;const S=o<800?90:170;for(let E=0;E<S;E+=1)s.push({x:Math.random()*o,y:u*.56+Math.random()*u*.42,r:Math.random()*1.5+.25,a:Math.random()*.34+.1,s:Math.random()*.34+.08})},p=()=>{c+=.006,i.clearRect(0,0,o,u),s.forEach((g,_)=>{g.x+=Math.sin(c+_)*g.s,g.y+=Math.cos(c*.8+_)*g.s*.55,g.x<-4&&(g.x=o+4),g.x>o+4&&(g.x=-4),i.globalAlpha=g.a,i.fillStyle="#e6e5df",i.beginPath(),i.arc(g.x,g.y,g.r,0,Math.PI*2),i.fill()}),i.globalAlpha=1,d=requestAnimationFrame(p)};return h(),window.addEventListener("resize",h),d=requestAnimationFrame(p),()=>{cancelAnimationFrame(d),window.removeEventListener("resize",h)}},[]),he.jsx("canvas",{ref:a,"aria-hidden":"true"})}function OR(){const a=pt.useRef(null);return pt.useEffect(()=>{const e=a.current,t=e==null?void 0:e.closest(".hero");if(!e||!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const s=new fA({alpha:!0,antialias:!1,powerPreference:"high-performance"});s.setClearColor(0,0),s.setPixelRatio(Math.min(window.devicePixelRatio||1,1.25)),e.appendChild(s.domElement);const o=new Ky,u=new xp(-1,1,1,-1,0,1),c=new Tl(2,2,1,1),d={uTime:{value:0},uResolution:{value:new yt(1,1)},uMouse:{value:new yt(.56,.46)},uVelocity:{value:new yt(0,0)},uIntensity:{value:0}},h=new qi({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:d,vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),p=new fr(c,h);o.add(p);const g={width:1,height:1,targetX:.56,targetY:.46,x:.56,y:.46,lastX:.56,lastY:.46,vx:0,vy:0,intensity:0,targetIntensity:0,lastMove:0};let _=0;const S=()=>{const x=t.getBoundingClientRect();g.width=Math.max(1,x.width),g.height=Math.max(1,x.height),s.setSize(g.width,g.height,!1),d.uResolution.value.set(g.width,g.height)},E=x=>{const y=t.getBoundingClientRect(),b=Math.max(0,Math.min(1,(x.clientX-y.left)/y.width)),I=Math.max(0,Math.min(1,1-(x.clientY-y.top)/y.height));g.vx+=(b-g.lastX)*.9,g.vy+=(I-g.lastY)*.9,g.lastX=b,g.lastY=I,g.targetX=b,g.targetY=I,g.targetIntensity=1,g.lastMove=performance.now()},M=x=>{x-g.lastMove>260&&(g.targetIntensity=0),g.x+=(g.targetX-g.x)*.055,g.y+=(g.targetY-g.y)*.055,g.vx*=.9,g.vy*=.9,g.intensity+=(g.targetIntensity-g.intensity)*.065,d.uTime.value=x*.001,d.uMouse.value.set(g.x,g.y),d.uVelocity.value.set(g.vx,g.vy),d.uIntensity.value=g.intensity,s.render(o,u),_=requestAnimationFrame(M)};return S(),window.addEventListener("resize",S),t.addEventListener("pointermove",E),_=requestAnimationFrame(M),()=>{cancelAnimationFrame(_),window.removeEventListener("resize",S),t.removeEventListener("pointermove",E),c.dispose(),h.dispose(),s.dispose(),s.domElement.remove()}},[]),he.jsx("div",{className:"three-fluid-layer",ref:a,"aria-hidden":"true"})}function kR({className:a="hero-meta"}){const[e,t]=pt.useState(()=>new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Shanghai",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(new Date));return pt.useEffect(()=>{const i=new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Shanghai",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}),s=window.setInterval(()=>{t(i.format(new Date))},1e3);return()=>window.clearInterval(s)},[]),he.jsxs("div",{className:a,"aria-label":"FOSHAN COORDINATES AND CURRENT TIME",children:[he.jsx("span",{children:"FOSHAN"}),he.jsx("span",{children:"23.0215° N / 113.1214° E"}),he.jsx("time",{children:e})]})}function BR(){return he.jsxs("header",{className:"site-header",children:[he.jsxs("a",{className:"brand",href:"#home","aria-label":"STUDIO HOME",children:[he.jsx("span",{}),he.jsx("strong",{children:"PORTFOLIO"})]}),he.jsxs("nav",{"aria-label":"PRIMARY NAVIGATION",children:[he.jsx("a",{href:"#about",children:"ABOUT"}),he.jsx("a",{href:"#portfolio",children:"PROJECT"}),he.jsx("a",{href:"#cases",children:"SELECTED CASES"}),he.jsx("a",{href:"#contact",children:"CONTACT"})]}),he.jsx("span",{className:"header-balance","aria-hidden":"true"})]})}function zR(){return he.jsxs("div",{className:"hero-pressure-title","aria-label":"HELLO THIS IS MY STUDIO",children:[he.jsx("div",{className:"pressure-line pressure-line-hello",children:he.jsx(D0,{text:"HELLO",flex:!0,alpha:!1,stroke:!1,width:!0,weight:!0,italic:!1,textColor:"#f4f1ea",strokeColor:"#f4f1ea",className:"hero-pressure-text",minFontSize:72})}),he.jsx("div",{className:"pressure-line pressure-line-studio",children:he.jsx(D0,{text:"THIS IS MY STUDIO",flex:!0,alpha:!1,stroke:!1,width:!0,weight:!0,italic:!1,textColor:"#f4f1ea",strokeColor:"#f4f1ea",className:"hero-pressure-text",minFontSize:48})})]})}function VR(){return he.jsxs("section",{className:"hero",id:"home",children:[he.jsx("video",{className:"hero-bg-video",src:Al("/视频/网页首页鲸鱼光影视频_3.mp4"),autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-hidden":"true"}),he.jsx("div",{className:"hero-video-shade","aria-hidden":"true"}),he.jsx("div",{className:"hero-particles",children:he.jsx(FR,{})}),he.jsx(OR,{}),he.jsx(kR,{}),he.jsxs("div",{className:"hero-copy reveal",children:[he.jsx("p",{className:"eyebrow",children:"CREATIVE STUDIO / BRAND SYSTEM / MOTION"}),he.jsx(zR,{}),he.jsx("p",{className:"hero-cn",children:"让视觉回归纯粹，用克制的设计，构建有生命力的品牌生态。"})]}),he.jsxs("div",{className:"hero-index reveal",children:[he.jsx("span",{children:"01"}),he.jsx("span",{children:"LIQUID IDENTITY FIELD"})]})]})}function HR(){const a=["WE","SHAPE","QUIET","SYSTEMS","THAT","MOVE"];return he.jsxs("section",{className:"video-statement",id:"motion",children:[he.jsxs("div",{className:"video-copy reveal",children:[he.jsx("p",{className:"eyebrow",children:"02 / MOTION STUDY"}),he.jsx("h2",{"aria-label":"WE SHAPE QUIET SYSTEMS THAT MOVE",children:a.map((e,t)=>he.jsx("span",{style:{"--i":t},children:e},e))}),he.jsx("p",{children:"A RESTRAINED MOTION LAYER, PLACED BEHIND TYPOGRAPHY AND TUNED FOR SLOW CINEMATIC SCROLLING."})]}),he.jsx("div",{className:"video-frame scroll-motion reveal","data-depth":"1",children:he.jsx("video",{src:Al("/视频/0.mp4"),autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-label":"STUDIO MOTION REEL"})})]})}function GR(){const a=pt.useMemo(()=>ap.portfolio||[],[]),e=pt.useMemo(()=>{const i=Math.ceil(a.length/2);return[{label:"TOP PORTFOLIO PROJECTS",items:a.slice(0,i),direction:"left"},{label:"BOTTOM PORTFOLIO PROJECTS",items:a.slice(i),direction:"right"}]},[a]),t=(i,s,o,u)=>{const c=i.width&&i.height?i.width/i.height:1;return he.jsx("article",{className:`project-card project-${i.orientation.toLowerCase()}`,style:{"--project-ratio":c},children:he.jsx("img",{src:Al(i.src),alt:i.title||"Portfolio project",loading:u<4?"eager":"lazy"})},`${s}-${o}-${i.src}-${u}`)};return he.jsxs("section",{className:"portfolio-slider",id:"portfolio",children:[he.jsxs("div",{className:"section-head reveal",children:[he.jsxs("div",{children:[he.jsx("p",{className:"eyebrow",children:"03 / PROJECT CARDS"}),he.jsx("h2",{children:"PORTFOLIO"})]}),he.jsx("span",{children:"CONTINUOUSLY LOOPING PROJECT CARDS. TWO ROWS DRIFT IN OPPOSITE DIRECTIONS AND PAUSE ON HOVER."})]}),he.jsx("div",{className:"slider-shell reveal",children:e.map(i=>he.jsxs("div",{className:`project-track project-track-${i.direction}`,"aria-label":i.label,children:[he.jsx("div",{className:"project-track-group",children:i.items.map((s,o)=>t(s,i.direction,0,o))}),he.jsx("div",{className:"project-track-group","aria-hidden":"true",children:i.items.map((s,o)=>t(s,i.direction,1,o))})]},i.direction))})]})}function WR(){const a=pt.useRef([]),e=pt.useMemo(()=>[...ap.featured||[],...ap.portfolio||[]],[]),t=pt.useMemo(()=>[{name:"主视觉",en:"KEY VISUAL",description:"品牌KV、活动KV、Campaign主视觉、节日主视觉、产品主视觉",code:"01",tone:"light",images:e.slice(0,3)},{name:"海报",en:"DIGITAL DESIGN",description:"海报、详情页、Banner、公众号视觉、社交媒体、电商视觉",code:"02",tone:"dark",images:e.slice(2,5)},{name:"IP设计",en:"IP DESIGN",description:"IP形象、三视图、表情、动作、角色延展、IP海报",code:"03",tone:"mid",images:e.slice(4,7)},{name:"物料延展",en:"COLLATERAL",description:"宣传册、折页、单张、礼盒、卡券、手提袋、周边、印刷品",code:"04",tone:"light",images:e.slice(1,4)},{name:"空间活动",en:"EVENT & SPACE",description:"活动、会议、展会、美陈、路演、门店活动、空间视觉应用",code:"05",tone:"dark",images:e.slice(5,8)},{name:"品牌视觉",en:"BRAND IDENTITY",description:"Logo、VI、品牌色彩、字体规范、品牌视觉系统、SI视觉、品牌升级",code:"06",tone:"mid",images:e.slice(7,10)}],[e]);return pt.useEffect(()=>{const i=a.current.filter(Boolean),s=i.map(o=>{const u=o.querySelectorAll(".archive-preview"),c=()=>{i.forEach(h=>cs.to(h,{opacity:h===o?1:.15,duration:.62,ease:"power4.out",overwrite:!0})),cs.to(o,{zIndex:50,duration:.01,overwrite:!0}),cs.fromTo(u,{y:30,x:0,rotation:0,scale:.96,opacity:0},{y:h=>-58-h*28,x:h=>[-42,18,62][h%3],rotation:h=>[-7,4,8][h%3],scale:1,opacity:1,duration:.62,stagger:.055,ease:"expo.out",overwrite:!0})},d=()=>{cs.to(i,{opacity:1,duration:.62,ease:"power4.out",overwrite:!0}),cs.to(o,{zIndex:"",duration:.01,overwrite:!0}),cs.to(u,{y:16,x:0,rotation:0,scale:.96,opacity:0,duration:.55,stagger:.04,ease:"power4.out",overwrite:!0})};return o.addEventListener("mouseenter",c),o.addEventListener("mouseleave",d),cs.set(u,{y:16,opacity:0,scale:.96}),()=>{o.removeEventListener("mouseenter",c),o.removeEventListener("mouseleave",d)}});return()=>s.forEach(o=>o())},[t]),he.jsxs("section",{className:"archive-cases section",id:"cases",children:[he.jsxs("div",{className:"archive-heading reveal",children:[he.jsx("p",{className:"eyebrow",children:"04 / WORKS"}),he.jsx("h2",{children:"WORKS"}),he.jsx("span",{children:"AN ARCHIVE OF VISUAL SYSTEMS, MOVING IMAGE AND DIGITAL WORLDS."})]}),he.jsx("div",{className:"archive-stack",children:t.map((i,s)=>he.jsxs("article",{className:`archive-case archive-case-${s+1}`,ref:o=>{a.current[s]=o},children:[he.jsx("div",{className:"archive-previews","aria-hidden":"true",children:i.images.map((o,u)=>he.jsx("img",{className:"archive-preview",src:Al(o.src),alt:""},`${o.src}-${u}`))}),he.jsxs("div",{className:`archive-folder archive-folder-${i.tone}`,children:[he.jsx("div",{className:"archive-tab"}),he.jsx("span",{className:"archive-code",children:i.code}),he.jsxs("h3",{children:[he.jsx("strong",{children:i.name}),he.jsx("small",{children:i.en})]}),he.jsx("p",{className:"archive-description",children:i.description}),he.jsxs("span",{className:"archive-count",children:[String(i.images.length).padStart(2,"0")," PROJECTS"]})]})]},i.code))})]})}function XR(){const a=pt.useRef(null);return pt.useEffect(()=>{const e=a.current,t=e==null?void 0:e.closest(".about");if(!e||!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const s={x:50,y:50,targetX:50,targetY:50,intensity:0,targetIntensity:0};let o=0;const u=h=>{const p=t.getBoundingClientRect();s.targetX=(h.clientX-p.left)/p.width*100,s.targetY=(h.clientY-p.top)/p.height*100,s.targetIntensity=1},c=()=>{s.targetIntensity=0},d=()=>{s.x+=(s.targetX-s.x)*.16,s.y+=(s.targetY-s.y)*.16,s.intensity+=(s.targetIntensity-s.intensity)*.12,e.style.setProperty("--about-x",`${s.x.toFixed(2)}%`),e.style.setProperty("--about-y",`${s.y.toFixed(2)}%`),e.style.setProperty("--about-reveal",s.intensity.toFixed(4)),o=requestAnimationFrame(d)};return t.addEventListener("pointermove",u),t.addEventListener("pointerleave",c),o=requestAnimationFrame(d),()=>{cancelAnimationFrame(o),t.removeEventListener("pointermove",u),t.removeEventListener("pointerleave",c)}},[]),he.jsx("div",{className:"about-color-reveal",ref:a,"aria-hidden":"true"})}function YR(){return he.jsxs("section",{className:"about section",id:"about",children:[he.jsx(XR,{}),he.jsxs("div",{className:"about-copy reveal",children:[he.jsx("p",{className:"eyebrow",children:"05 / ABOUT THE STUDIO"}),he.jsx("h2",{children:"PURE DESIGN BEGINS WITH A CONVERSATION."}),he.jsx("p",{className:"about-cn",children:"回归纯粹，始于对话。"})]}),he.jsx("div",{className:"about-line","aria-hidden":"true"})]})}function qR(){const a=pt.useRef(null);return pt.useEffect(()=>{const e=a.current,t=e==null?void 0:e.closest(".contact");if(!e||!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const s={x:50,y:50,targetX:50,targetY:50,intensity:0,targetIntensity:0};let o=0;const u=h=>{const p=t.getBoundingClientRect();s.targetX=(h.clientX-p.left)/p.width*100,s.targetY=(h.clientY-p.top)/p.height*100,s.targetIntensity=1},c=()=>{s.targetIntensity=0},d=()=>{s.x+=(s.targetX-s.x)*.16,s.y+=(s.targetY-s.y)*.16,s.intensity+=(s.targetIntensity-s.intensity)*.12,e.style.setProperty("--contact-x",`${s.x.toFixed(2)}%`),e.style.setProperty("--contact-y",`${s.y.toFixed(2)}%`),e.style.setProperty("--contact-reveal",s.intensity.toFixed(4)),o=requestAnimationFrame(d)};return t.addEventListener("pointermove",u),t.addEventListener("pointerleave",c),o=requestAnimationFrame(d),()=>{cancelAnimationFrame(o),t.removeEventListener("pointermove",u),t.removeEventListener("pointerleave",c)}},[]),he.jsx("div",{className:"contact-image-reveal",ref:a,"aria-hidden":"true"})}function $R(){return he.jsxs("section",{className:"contact closing-section",id:"contact",children:[he.jsx(qR,{}),he.jsx("span",{className:"closing-dot reveal","aria-hidden":"true"}),he.jsx("p",{className:"eyebrow reveal",children:"06 / CONTACT"}),he.jsx("h2",{className:"reveal",children:"LET'S WORK TOGETHER"}),he.jsxs("div",{className:"closing-bar reveal",children:[he.jsx("a",{href:"mailto:hello@studio.com",children:"HELLO@STUDIO.COM"}),he.jsx("a",{className:"wechat-link",href:"#wechat-qr","aria-label":"SHOW WECHAT QR CODE",children:"WECHAT"}),he.jsx("a",{className:"back-top",href:"#home","aria-label":"BACK TO TOP",children:"BACK TO TOP"})]}),he.jsxs("div",{className:"wechat-modal",id:"wechat-qr","aria-label":"WECHAT QR CODE",children:[he.jsx("a",{className:"wechat-modal-backdrop",href:"#contact","aria-label":"CLOSE WECHAT QR CODE"}),he.jsxs("div",{className:"wechat-modal-panel",role:"dialog","aria-modal":"true","aria-label":"WECHAT QR CODE",children:[he.jsx("img",{src:Al("/底图/wechat-qr.jpg"),alt:"WECHAT QR CODE"}),he.jsx("span",{children:"WECHAT"}),he.jsx("a",{href:"#contact","aria-label":"CLOSE WECHAT QR CODE",children:"CLOSE"})]})]})]})}function KR(){return NR(),UR(),he.jsxs(he.Fragment,{children:[he.jsx(IR,{}),he.jsx(BR,{}),he.jsxs("main",{children:[he.jsx(VR,{}),he.jsx(HR,{}),he.jsx(GR,{}),he.jsx(WR,{}),he.jsx(YR,{}),he.jsx($R,{})]}),he.jsx("footer",{className:"site-footer",children:"MADE ON HEANGEUN"})]})}QS.createRoot(document.getElementById("root")).render(he.jsx(YS.StrictMode,{children:he.jsx(KR,{})}));
