...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),[n,_,x]),Z=[g,d?"text-pressure-flex":"",p?"text-pressure-stroke":""].filter(Boolean).join(" ");return fe.jsxs("div",{ref:w,className:"text-pressure-shell",children:[z,fe.jsx("h1",{ref:C,className:`text-pressure-title ${Z}`,style:{fontFamily:e,textTransform:"uppercase",fontSize:O,lineHeight:F,transform:`scale(1, ${U})`,transformOrigin:"center top",margin:0,textAlign:"center",userSelect:"none",whiteSpace:"nowrap",fontWeight:100,width:"100%"},children:L.map((re,he)=>fe.jsx("span",{ref:q=>{S.current[he]=q},"data-char":re,style:{display:"inline-block",color:p?void 0:x,transformOrigin:"50% 60%",transition:"color 180ms ease",willChange:"transform, font-variation-settings"},children:re===" "?" ":re},`${re}-${he}`))})]})}const Sg=window.STUDIO_DATA||{featured:[],portfolio:[]},Za=(s="")=>!s||/^(https?:|data:|blob:)/i.test(s)?s:`/heangeun/${String(s).replace(/^\/+/,"")}`;function wE(){const[s,e]=pt.useState(0),[n,r]=pt.useState(!1),[o,u]=pt.useState(!0);return pt.useEffect(()=>{const c=performance.now(),d=1180;let p=0;const m=x=>{const _=x-c,g=Math.min(_/d,1),M=1-Math.pow(1-g,3),w=g<.94?Math.sin(x*.055)*2.6+Math.sin(x*.017)*1.4:0,C=Math.max(0,Math.min(100,Math.floor(M*100+w)));e(C),g<1?p=requestAnimationFrame(m):(e(100),window.setTimeout(()=>r(!0),180),window.setTimeout(()=>u(!1),820))};return p=requestAnimationFrame(m),()=>cancelAnimationFrame(p)},[]),o?fe.jsxs("div",{className:`loading-intro${n?" is-done":""}`,"aria-label":"LOADING",children:[fe.jsxs("div",{className:"loading-symbols","aria-hidden":"true",children:[fe.jsx("span",{children:"+"}),fe.jsx("span",{children:"%"}),fe.jsx("span",{children:"+"}),fe.jsx("span",{children:"/"})]}),fe.jsxs("div",{className:"loading-count",children:[fe.jsx("span",{children:String(s).padStart(2,"0")}),fe.jsx("em",{children:"%"})]}),fe.jsx("div",{className:"loading-track","aria-hidden":"true",children:fe.jsx("span",{style:{transform:`scaleX(${s/100})`}})})]}):null}function AE(){pt.useEffect(()=>{const s=new IntersectionObserver(e=>{e.forEach(n=>{n.isIntersecting&&n.target.classList.add("is-visible")})},{threshold:.16});return document.querySelectorAll(".reveal").forEach(e=>s.observe(e)),()=>s.disconnect()},[])}function RE(){pt.useEffect(()=>{let s=0;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const n=()=>{const r=window.innerHeight||1;document.querySelectorAll(".scroll-motion").forEach(o=>{const u=o.getBoundingClientRect(),c=u.top+u.height/2,d=Math.max(-1,Math.min(1,(c-r/2)/r)),p=Number(o.dataset.depth||0);o.style.setProperty("--scroll-y",`${(d*-44+p*14).toFixed(2)}px`),o.style.setProperty("--scroll-scale",`${(1.015-Math.abs(d)*.045).toFixed(3)}`)}),s=requestAnimationFrame(n)};return s=requestAnimationFrame(n),()=>cancelAnimationFrame(s)},[])}function CE(){const s=pt.useRef(null);return pt.useEffect(()=>{const e=s.current;if(!e||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const r=e.getContext("2d",{alpha:!0}),o=[];let u=0,c=0,d=0,p=0;const m=()=>{const _=e.parentElement.getBoundingClientRect(),g=1;u=Math.max(1,_.width),c=Math.max(1,_.height),e.width=Math.floor(u*g),e.height=Math.floor(c*g),e.style.width=`${u}px`,e.style.height=`${c}px`,r.setTransform(g,0,0,g,0,0),o.length=0;const M=u<800?90:170;for(let w=0;w<M;w+=1)o.push({x:Math.random()*u,y:c*.56+Math.random()*c*.42,r:Math.random()*1.5+.25,a:Math.random()*.34+.1,s:Math.random()*.34+.08})},x=()=>{d+=.006,r.clearRect(0,0,u,c),o.forEach((_,g)=>{_.x+=Math.sin(d+g)*_.s,_.y+=Math.cos(d*.8+g)*_.s*.55,_.x<-4&&(_.x=u+4),_.x>u+4&&(_.x=-4),r.globalAlpha=_.a,r.fillStyle="#e6e5df",r.beginPath(),r.arc(_.x,_.y,_.r,0,Math.PI*2),r.fill()}),r.globalAlpha=1,p=requestAnimationFrame(x)};return m(),window.addEventListener("resize",m),p=requestAnimationFrame(x),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",m)}},[]),fe.jsx("canvas",{ref:s,"aria-hidden":"true"})}function bE(){const s=pt.useRef(null);return pt.useEffect(()=>{const e=s.current,n=e==null?void 0:e.closest(".hero");if(!e||!n||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const o=new ME({alpha:!0,antialias:!1,powerPreference:"high-performance"});o.setClearColor(0,0),o.setPixelRatio(Math.min(window.devicePixelRatio||1,1.25)),e.appendChild(o.domElement);const u=new av,c=new od(-1,1,1,-1,0,1),d=new Ka(2,2,1,1),p={uTime:{value:0},uResolution:{value:new St(1,1)},uMouse:{value:new St(.56,.46)},uVelocity:{value:new St(0,0)},uIntensity:{value:0}},m=new _i({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:p,vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),x=new Di(d,m);u.add(x);const _={width:1,height:1,targetX:.56,targetY:.46,x:.56,y:.46,lastX:.56,lastY:.46,vx:0,vy:0,intensity:0,targetIntensity:0,lastMove:0};let g=0;const M=()=>{const S=n.getBoundingClientRect();_.width=Math.max(1,S.width),_.height=Math.max(1,S.height),o.setSize(_.width,_.height,!1),p.uResolution.value.set(_.width,_.height)},w=S=>{const v=n.getBoundingClientRect(),I=Math.max(0,Math.min(1,(S.clientX-v.left)/v.width)),O=Math.max(0,Math.min(1,1-(S.clientY-v.top)/v.height));_.vx+=(I-_.lastX)*.9,_.vy+=(O-_.lastY)*.9,_.lastX=I,_.lastY=O,_.targetX=I,_.targetY=O,_.targetIntensity=1,_.lastMove=performance.now()},C=S=>{S-_.lastMove>260&&(_.targetIntensity=0),_.x+=(_.targetX-_.x)*.055,_.y+=(_.targetY-_.y)*.055,_.vx*=.9,_.vy*=.9,_.intensity+=(_.targetIntensity-_.intensity)*.065,p.uTime.value=S*.001,p.uMouse.value.set(_.x,_.y),p.uVelocity.value.set(_.vx,_.vy),p.uIntensity.value=_.intensity,o.render(u,c),g=requestAnimationFrame(C)};return M(),window.addEventListener("resize",M),n.addEventListener("pointermove",w),g=requestAnimationFrame(C),()=>{cancelAnimationFrame(g),window.removeEventListener("resize",M),n.removeEventListener("pointermove",w),d.dispose(),m.dispose(),o.dispose(),o.domElement.remove()}},[]),fe.jsx("div",{className:"three-fluid-layer",ref:s,"aria-hidden":"true"})}function PE({className:s="hero-meta"}){const[e,n]=pt.useState(()=>new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Shanghai",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(new Date));return pt.useEffect(()=>{const r=new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Shanghai",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}),o=window.setInterval(()=>{n(r.format(new Date))},1e3);return()=>window.clearInterval(o)},[]),fe.jsxs("div",{className:s,"aria-label":"FOSHAN COORDINATES AND CURRENT TIME",children:[fe.jsx("span",{children:"FOSHAN"}),fe.jsx("span",{children:"23.0215° N / 113.1214° E"}),fe.jsx("time",{children:e})]})}function LE(){return fe.jsxs("header",{className:"site-header",children:[fe.jsxs("a",{className:"brand",href:"#home","aria-label":"STUDIO HOME",children:[fe.jsx("span",{}),fe.jsx("strong",{children:"PORTFOLIO"})]}),fe.jsxs("nav",{"aria-label":"PRIMARY NAVIGATION",children:[fe.jsx("a",{href:"#about",children:"ABOUT"}),fe.jsx("a",{href:"#portfolio",children:"PROJECT"}),fe.jsx("a",{href:"#cases",children:"SELECTED CASES"}),fe.jsx("a",{href:"#contact",children:"CONTACT"})]}),fe.jsx("span",{className:"header-balance","aria-hidden":"true"})]})}function DE(){return fe.jsxs("div",{className:"hero-pressure-title","aria-label":"HELLO THIS IS MY STUDIO",children:[fe.jsx("div",{className:"pressure-line pressure-line-hello",children:fe.jsx(Om,{text:"HELLO",flex:!0,alpha:!1,stroke:!1,width:!0,weight:!0,italic:!1,textColor:"#f4f1ea",strokeColor:"#f4f1ea",className:"hero-pressure-text",minFontSize:72})}),fe.jsx("div",{className:"pressure-line pressure-line-studio",children:fe.jsx(Om,{text:"THIS IS MY STUDIO",flex:!0,alpha:!1,stroke:!1,width:!0,weight:!0,italic:!1,textColor:"#f4f1ea",strokeColor:"#f4f1ea",className:"hero-pressure-text",minFontSize:48})})]})}function NE(){return fe.jsxs("section",{className:"hero",id:"home",children:[fe.jsx("video",{className:"hero-bg-video",src:Za("/视频/网页首页鲸鱼光影视频_3.mp4"),autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-hidden":"true"}),fe.jsx("div",{className:"hero-video-shade","aria-hidden":"true"}),fe.jsx("div",{className:"hero-particles",children:fe.jsx(CE,{})}),fe.jsx(bE,{}),fe.jsx(PE,{}),fe.jsxs("div",{className:"hero-copy reveal",children:[fe.jsx("p",{className:"eyebrow",children:"CREATIVE STUDIO / BRAND SYSTEM / MOTION"}),fe.jsx(DE,{}),fe.jsx("p",{className:"hero-cn",children:"让视觉回归纯粹，用克制的设计，构建有生命力的品牌生态。"})]}),fe.jsxs("div",{className:"hero-index reveal",children:[fe.jsx("span",{children:"01"}),fe.jsx("span",{children:"LIQUID IDENTITY FIELD"})]})]})}function IE(){const s=["WE","SHAPE","QUIET","SYSTEMS","THAT","MOVE"];return fe.jsxs("section",{className:"video-statement",id:"motion",children:[fe.jsxs("div",{className:"video-copy reveal",children:[fe.jsx("p",{className:"eyebrow",children:"02 / MOTION STUDY"}),fe.jsx("h2",{"aria-label":"WE SHAPE QUIET SYSTEMS THAT MOVE",children:s.map((e,n)=>fe.jsx("span",{style:{"--i":n},children:e},e))}),fe.jsx("p",{children:"A RESTRAINED MOTION LAYER, PLACED BEHIND TYPOGRAPHY AND TUNED FOR SLOW CINEMATIC SCROLLING."})]}),fe.jsx("div",{className:"video-frame scroll-motion reveal","data-depth":"1",children:fe.jsx("video",{src:Za("/视频/0.mp4"),autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-label":"STUDIO MOTION REEL"})})]})}function UE(){const s=pt.useMemo(()=>Sg.portfolio||[],[]),e=pt.useMemo(()=>s.slice(0,12),[s]);e.find(p=>p.orientation==="Portrait")||e[0];const n=pt.useRef(null),r=pt.useRef(null);pt.useEffect(()=>{const p=r.current,m=n.current;if(!p||!m)return;const x=window.matchMedia("(prefers-reduced-motion: reduce)").matches,_={x:0,y:0,targetX:0,targetY:0};let g=0;const M=v=>{const I=m.getBoundingClientRect();_.targetX=((v.clientX-I.left)/I.width-.5)*2,_.targetY=((v.clientY-I.top)/I.height-.5)*2},w=()=>{_.targetX=0,_.targetY=0},C=()=>{const v=p.getBoundingClientRect(),I=Math.max(p.offsetHeight-window.innerHeight,1),O=Math.min(1,Math.max(0,-v.top/I));p.style.setProperty("--gallery-progress",O.toFixed(4)),m.style.setProperty("--gallery-progress",O.toFixed(4))},S=()=>{_.x+=(_.targetX-_.x)*.08,_.y+=(_.targetY-_.y)*.08,m.style.setProperty("--pointer-x",x?"0":_.x.toFixed(4)),m.style.setProperty("--pointer-y",x?"0":_.y.toFixed(4)),g=requestAnimationFrame(S)};return m.addEventListener("pointermove",M),m.addEventListener("pointerleave",w),window.addEventListener("scroll",C,{passive:!0}),C(),g=requestAnimationFrame(S),()=>{cancelAnimationFrame(g),m.removeEventListener("pointermove",M),m.removeEventListener("pointerleave",w),window.removeEventListener("scroll",C)}},[]);const o=["Brand Visual","Motion Design","IP Design","Web Experience","AI Visual System"],u=e.slice(0,9),[c,d]=pt.useState(0);return pt.useEffect(()=>{if(u.length<2)return;const p=window.setInterval(()=>{d(m=>(m+1)%u.length)},3200);return()=>window.clearInterval(p)},[u.length]),fe.jsx("section",{className:"floating-portfolio",id:"portfolio",ref:r,children:fe.jsxs("div",{className:"floating-sticky",children:[fe.jsxs("div",{className:"floating-intro reveal",children:[fe.jsx("p",{className:"eyebrow",children:"03 / LIVING VISUAL SYSTEM"}),fe.jsxs("h2",{children:["让视觉成为",fe.jsx("br",{}),fe.jsx("em",{children:"流动的系统"})]}),fe.jsx("div",{className:"floating-labels",children:o.map(p=>fe.jsx("span",{children:p},p))})]}),fe.jsxs("div",{className:"floating-stage",ref:n,children:[fe.jsx("div",{className:"floating-letter floating-letter-one","aria-hidden":"true",children:"A"}),fe.jsx("div",{className:"floating-letter floating-letter-two","aria-hidden":"true",children:"∞"}),fe.jsx("div",{className:"floating-fragment fragment-top",children:"FORM / MOTION / IMAGE"}),fe.jsx("div",{className:"floating-fragment fragment-bottom",children:"A VISUAL SYSTEM IN MOTION"}),fe.jsx("div",{className:"floating-rule rule-one","aria-hidden":"true"}),fe.jsx("div",{className:"floating-rule rule-two","aria-hidden":"true"}),u.map((p,m)=>{const x=(m-c+u.length)%u.length;return fe.jsxs("article",{className:`floating-card stack-card stack-card-position-${x}`,style:{"--stack-index":x},children:[fe.jsx("img",{src:Za(p.src),alt:p.title||"Portfolio project",loading:x<3?"eager":"lazy"}),fe.jsxs("span",{children:[String(m+1).padStart(2,"0")," / ",o[m%o.length]]})]},`${p.src}-${m}`)}),"          ",fe.jsxs("div",{className:"floating-note note-left",children:["SELECTED",fe.jsx("br",{}),"WORKS 2024—26"]}),fe.jsxs("div",{className:"floating-note note-right",children:["SCROLL TO",fe.jsx("br",{}),"ENTER THE ROOM"]})]})]})})}function FE(){return fe.jsxs("section",{className:"featured section",id:"cases",children:[fe.jsxs("div",{className:"section-head reveal",children:[fe.jsxs("div",{children:[fe.jsx("p",{className:"eyebrow",children:"04 / SELECTED CASES"}),fe.jsx("h2",{children:"FEATURED CASES"})]}),fe.jsx("span",{children:"LARGE-FORMAT CAMPAIGN VISUALS SHAPED THROUGH QUIET CONTRAST AND PRECISE VISUAL HIERARCHY."})]}),fe.jsx("div",{className:"featured-grid",children:Sg.featured.map((s,e)=>fe.jsxs("article",{className:"case-card reveal scroll-motion","data-depth":e%2===0?1:-1,children:[fe.jsxs("div",{className:"case-info",children:[fe.jsxs("span",{children:[String(e+1).padStart(2,"0")," / FEATURED CASE"]}),fe.jsx("h3",{children:s.title})]}),fe.jsx("div",{className:"case-image",children:fe.jsx("img",{src:Za(s.src),alt:s.title,loading:e===0?"eager":"lazy"})})]},s.src))})]})}function OE(){const s=pt.useRef(null);return pt.useEffect(()=>{const e=s.current,n=e==null?void 0:e.closest(".about");if(!e||!n||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const o={x:50,y:50,targetX:50,targetY:50,intensity:0,targetIntensity:0};let u=0;const c=m=>{const x=n.getBoundingClientRect();o.targetX=(m.clientX-x.left)/x.width*100,o.targetY=(m.clientY-x.top)/x.height*100,o.targetIntensity=1},d=()=>{o.targetIntensity=0},p=()=>{o.x+=(o.targetX-o.x)*.16,o.y+=(o.targetY-o.y)*.16,o.intensity+=(o.targetIntensity-o.intensity)*.12,e.style.setProperty("--about-x",`${o.x.toFixed(2)}%`),e.style.setProperty("--about-y",`${o.y.toFixed(2)}%`),e.style.setProperty("--about-reveal",o.intensity.toFixed(4)),u=requestAnimationFrame(p)};return n.addEventListener("pointermove",c),n.addEventListener("pointerleave",d),u=requestAnimationFrame(p),()=>{cancelAnimationFrame(u),n.removeEventListener("pointermove",c),n.removeEventListener("pointerleave",d)}},[]),fe.jsx("div",{className:"about-color-reveal",ref:s,"aria-hidden":"true"})}function BE(){return fe.jsxs("section",{className:"about section",id:"about",children:[fe.jsx(OE,{}),fe.jsxs("div",{className:"about-copy reveal",children:[fe.jsx("p",{className:"eyebrow",children:"05 / ABOUT THE STUDIO"}),fe.jsx("h2",{children:"PURE DESIGN BEGINS WITH A CONVERSATION."}),fe.jsx("p",{className:"about-cn",children:"回归纯粹，始于对话。"})]}),fe.jsx("div",{className:"about-line","aria-hidden":"true"})]})}function kE(){const s=pt.useRef(null);return pt.useEffect(()=>{const e=s.current,n=e==null?void 0:e.closest(".contact");if(!e||!n||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const o={x:50,y:50,targetX:50,targetY:50,intensity:0,targetIntensity:0};let u=0;const c=m=>{const x=n.getBoundingClientRect();o.targetX=(m.clientX-x.left)/x.width*100,o.targetY=(m.clientY-x.top)/x.height*100,o.targetIntensity=1},d=()=>{o.targetIntensity=0},p=()=>{o.x+=(o.targetX-o.x)*.16,o.y+=(o.targetY-o.y)*.16,o.intensity+=(o.targetIntensity-o.intensity)*.12,e.style.setProperty("--contact-x",`${o.x.toFixed(2)}%`),e.style.setProperty("--contact-y",`${o.y.toFixed(2)}%`),e.style.setProperty("--contact-reveal",o.intensity.toFixed(4)),u=requestAnimationFrame(p)};return n.addEventListener("pointermove",c),n.addEventListener("pointerleave",d),u=requestAnimationFrame(p),()=>{cancelAnimationFrame(u),n.removeEventListener("pointermove",c),n.removeEventListener("pointerleave",d)}},[]),fe.jsx("div",{className:"contact-image-reveal",ref:s,"aria-hidden":"true"})}function zE(){return fe.jsxs("section",{className:"contact closing-section",id:"contact",children:[fe.jsx(kE,{}),fe.jsx("span",{className:"closing-dot reveal","aria-hidden":"true"}),fe.jsx("p",{className:"eyebrow reveal",children:"06 / CONTACT"}),fe.jsx("h2",{className:"reveal",children:"LET'S WORK TOGETHER"}),fe.jsxs("div",{className:"closing-bar reveal",children:[fe.jsx("a",{href:"mailto:hello@studio.com",children:"HELLO@STUDIO.COM"}),fe.jsx("a",{className:"wechat-link",href:"#wechat-qr","aria-label":"SHOW WECHAT QR CODE",children:"WECHAT"}),fe.jsx("a",{className:"back-top",href:"#home","aria-label":"BACK TO TOP",children:"BACK TO TOP"})]}),fe.jsxs("div",{className:"wechat-modal",id:"wechat-qr","aria-label":"WECHAT QR CODE",children:[fe.jsx("a",{className:"wechat-modal-backdrop",href:"#contact","aria-label":"CLOSE WECHAT QR CODE"}),fe.jsxs("div",{className:"wechat-modal-panel",role:"dialog","aria-modal":"true","aria-label":"WECHAT QR CODE",children:[fe.jsx("img",{src:Za("/底图/wechat-qr.jpg"),alt:"WECHAT QR CODE"}),fe.jsx("span",{children:"WECHAT"}),fe.jsx("a",{href:"#contact","aria-label":"CLOSE WECHAT QR CODE",children:"CLOSE"})]})]})]})}function VE(){return AE(),RE(),fe.jsxs(fe.Fragment,{children:[fe.jsx(wE,{}),fe.jsx(LE,{}),fe.jsxs("main",{children:[fe.jsx(NE,{}),fe.jsx(IE,{}),fe.jsx(UE,{}),fe.jsx(FE,{}),fe.jsx(BE,{}),fe.jsx(zE,{})]}),fe.jsx("footer",{className:"site-footer",children:"MADE ON HEANGEUN"})]})}u_.createRoot(document.getElementById("root")).render(fe.jsx(i_.StrictMode,{children:fe.jsx(VE,{})}));
